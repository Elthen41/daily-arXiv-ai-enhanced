...
### [32] [SmoothAgent: Efficient Long-Horizon LLM-Based Agent Serving with Lookahead Context Engineering](https://arxiv.org/abs/2607.00151)
...
### [33] [Promise-Future Synchronization for Cluster Asynchronous Many-Task Runtimes via MPI One-Sided Communication](https://arxiv.org/abs/2607.00303)
*Mia Reitz*
...
### [34] [CloudyGUI: A Novel Python-based Framework for Auto-Scaling and Cloud Workload Analysis](https://arxiv.org/abs/2607.00455)
...
### [35] [ELDR: Expert-Locality-Aware Decode Routing for PD-Disaggregated MoE Serving](https://arxiv.org/abs/2607.00466)
...
### [36] [Modeling and Chasing the Energy-Efficiency Sweet Spots in Modern GPUs](https://arxiv.org/abs/2607.00819)
...
### [37] [Next-Generation Agentic Reinforcement Learning Systems Enable Self-Evolving Agents](https://arxiv.org/abs/2607.01120)
...
### [38] [A Non-Line-of-Sight, Multi-Modality-based Side-Channel IP Theft Attack on Additive Manufacturing Using Dual Smartphones](https://arxiv.org/abs/2607.00186)
...
### [39] [Federated Sovereign Transport Protocol (FSTP): Verifiable Coordination Without Disclosure](https://arxiv.org/abs/2607.00213)
...
### [40] [(A)I Sees What You Don't: Exploiting New Attack Surfaces in Third-Party Mobile Agents](https://arxiv.org/abs/2607.00333)
...
### [41] [ReShift: Aha-Moment-Driven Reasoning-Level Backdoor Attacks on Vision-Language Models](https://arxiv.org/abs/2607.00361)
...
### [42] [SoK: Attack and Defense Landscape of Mobile On-device AI Systems](https://arxiv.org/abs/2607.00362)
...
### [43] [KidnapRAG: A Black-Box Attack for Hijacking Reasoning in Agentic Retrieval-Augmented Generation Systems](https://arxiv.org/abs/2607.00422)
...
### [44] [All-out Attack: Optimal Block Withholding Under Pay-Per-Share Scheme](https://arxiv.org/abs/2607.01209)
...
### [45] [Minos: A Multi-Agent Collaborative Framework for Provenance-Based Backward Tracking](https://arxiv.org/abs/2607.00440)
...
### [46] [Beyond the Prompt: Jailbreaking Function-Calling LLMs via Simulated Moderation Traces](https://arxiv.org/abs/2607.00481)
...
### [47] [Cross-Domain Generalization Failure in Lightweight Intrusion Detection Models for IIoT Networks](https://arxiv.org/abs/2607.00553)
...
### [48] [The Rise and Fall of Google's Privacy Sandbox](https://arxiv.org/abs/2607.00693)
...
### [49] [Know Thy Neighbor: Cross-TEE Mutual Attestation](https://arxiv.org/abs/2607.00695)
...
### [50] [Forensic-Oriented Intrusion Detection Using Synthetic Network Traffic Data and Explainable Artificial Intelligence](https://arxiv.org/abs/2607.00763)
...
### [51] [No Country for Old Privacy: The Evolving Challenges of Anonymity in Bitcoin](https://arxiv.org/abs/2607.00772)
...
### [52] [Toward a Unified Security and Privacy Framework for AI-Native 6G Networks](https://arxiv.org/abs/2607.01019)
...
### [53] [Antaeus: Hunting Repository-Level Logic Vulnerabilities via Context-Grounded LLM Reasoning](https://arxiv.org/abs/2607.01138)
...
### [54] [Detecting Adversarial Evasion Attacks Against Autoencoder-Based Network Intrusion Detection Systems](https://arxiv.org/abs/2607.01194)
...
### [55] [HySpecPro: Scalable Hypergraph Partitioning via Spectral Projection Optimization](https://arxiv.org/abs/2607.00055)
...
### [56] [High-Performance NTT Accelerators for PQC leveraging Unified Redundant Arithmetic and Fine-Tuned Microarchitecture](https://arxiv.org/abs/2607.00621)
