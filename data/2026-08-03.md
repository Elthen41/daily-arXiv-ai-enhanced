...
### [1] [DeltaServe: Host-Agnostic Co-Serving of Inference and Fine-Tuning for LLMs](https://arxiv.org/abs/2607.28848)
...
### [2] [LayoutBench: Performance Benchmarking of Cloud Storage Layouts for Multimedia Data](https://arxiv.org/abs/2607.28880)
...
### [3] [Rethinking AI Cloud Infrastructure for Agentic Serving Systems with the Aries Experimentation Framework](https://arxiv.org/abs/2607.29069)
...
### [4] [Knox: Fortifying Smart Spaces With Safety Guarantees](https://arxiv.org/abs/2607.29198)
...
### [5] [Allocation Tracking and Parameter Checking for Parallel Programming Models using Contracts](https://arxiv.org/abs/2607.29303)
...
### [6] [CARA: Exact Local Repair with Fresh One-Action Certification for Cloud Consolidation](https://arxiv.org/abs/2607.29465)
...
### [7] [System-Wide Termination in Distributed Betweenness Centrality Computation](https://arxiv.org/abs/2607.29474)
...
### [9] [Optical Flow Sensor: A Direction-Selective Bionic Retina Design](https://arxiv.org/abs/2607.28686)
...
### [10] [WitCert: Sound Runtime Risk Observability and Gating for KV-Cache Quantization](https://arxiv.org/abs/2607.28699)
*Fanzhe Wei,Li Liu*
...
### [11] [Characterizing LLM Kernel Access and Memory Interaction in Multi-Partition NUMA GPUs](https://arxiv.org/abs/2607.28824)
...
### [12] [Open-Source LLM-Driven Formal Verification: A Multi-Agent Pipeline for RTL Repair](https://arxiv.org/abs/2607.28877)
*Ha Trung Tran*
...
### [13] [Selective KV Cache Protection for Noise-Resilient LLM Inference on Analog Compute-In-Memory Systems](https://arxiv.org/abs/2607.29076)
...
### [14] [RTLCurator: Label-Efficient Data Curation for RTL Generation](https://arxiv.org/abs/2607.29283)
...
### [15] [Low-Power PLL-Based Clock Stabilization for Flexible IGZO AMS Systems](https://arxiv.org/abs/2607.29357)
...
### [16] [Bridging the Gap Between PHE and FHE: A Performance and Trade-off Analysis of The Somewhat Homomorphic BGN Cryptosystem](https://arxiv.org/abs/2607.28700)
...
### [17] [Costs of Arbitrary Real Matrix Factorizations for Pure-DP Continual Counting](https://arxiv.org/abs/2607.28703)
...
### [18] [Blockchain Transaction Simulation Phishing](https://arxiv.org/abs/2607.28747)
...
### [19] [Partial Derandomization for Leakage-Resilient Shamir's Secret Sharing over Composite Order Fields](https://arxiv.org/abs/2607.28757)
*S. Venkitesh*
...
### [20] [YazSes: An Offline, Privacy-First, Cross-Platform Hold-to-Talk Voice-Dictation System](https://arxiv.org/abs/2607.28878)
...
### [21] [Hollow-LLM Attack: Computationally Trivial Weights in Zero-Knowledge Verification of LLM Inference](https://arxiv.org/abs/2607.28884)
...
### [22] [A Biometric Sensor Network to Enable Real-Time Measurement of Individual Student Engagement in STEM Lecture Environments](https://arxiv.org/abs/2607.28944)
*Ahmed Elsayed*
...
### [23] [MESS: Fast and Private Semantic Search on Multi-Graph HNSW](https://arxiv.org/abs/2607.28999)
...
### [24] [GoldenRetriever: Non-Interactive Homomorphic Encrypted Retrieval for Privacy-Preserving RAG](https://arxiv.org/abs/2607.29019)
...
### [25] [Memory Provenance Laundering in LLM Agents: A Non-Amplification Firewall for Persistent Memory](https://arxiv.org/abs/2607.29167)
...
### [26] [Alignment Is Local: A Paired Diagnostic for GUI Agents under User-Side Persuasion](https://arxiv.org/abs/2607.29199)
...
### [27] [MOSAIC: Masked Outsourcing of Secure AI Computations](https://arxiv.org/abs/2607.29221)
...
### [28] [JUNO: Aggregated Vector Consensus for Optimal Asynchronous Common Subset](https://arxiv.org/abs/2607.29244)
...
### [29] [On the Resilience of 5G NR Against Jamming](https://arxiv.org/abs/2607.29384)
...
### [30] [On fair and realistic performance evaluations for graph-based lateral movement detectors](https://arxiv.org/abs/2607.29390)
*Corentin Larroche*
...
### [31] [Enforcing Cryptographic Distributed-VCS Access Control with No Trust on Servers](https://arxiv.org/abs/2607.29417)
...
### [32] [Bending the Curve: Operational Cyber Epidemiology for Ransomware](https://arxiv.org/abs/2607.29444)
...
### [33] [Beyond Resilience: Antifragility in Critical Infrastructure Cybersecurity](https://arxiv.org/abs/2607.29550)
...
### [34] [CWEEP: A Lexical Static Analysis Framework for CWE Early Prevention](https://arxiv.org/abs/2607.29604)
...
### [35] [OpenClaw and Ollama in Agentic AI: Toward Fully Autonomous and Scalable AI Agent Systems](https://arxiv.org/abs/2607.28629)
...
### [36] [Can AI Evaluate AI Scientists? A Benchmarking Study of Autonomous Research Generation Systems Using Automated Multi-Model Review](https://arxiv.org/abs/2607.28631)
...
### [37] [LLM Framework for Discovering Major Mathematical Conjectures: AI's Quest for the Next Riemann Hypothesis](https://arxiv.org/abs/2607.28632)
...
### [38] [ThinkReset: Learnable Intermediate Interface Construction for Bounded-Context Long-Horizon Reasoning](https://arxiv.org/abs/2607.28642)
...
### [40] [Empowering Cross-Domain Sequential Recommendation with Hybrid Tokenization and Serial-Parallel Decoding](https://arxiv.org/abs/2607.28659)
...
### [41] [An Ontology-Guided, Deduplication-Aware Extraction Layer for Knowledge Graph Construction from Heterogeneous Documents](https://arxiv.org/abs/2607.28662)
...
### [42] [How Hard Does It Think? Analyzing Step-Aware Reasoning Energy in LLM Chain-of-Thought Trajectories](https://arxiv.org/abs/2607.28674)
...
### [43] [Reasoning in Real World Clinical Care: Why Large Language Models Are Not Yet Safe for Autonomous Clinical Decision Support](https://arxiv.org/abs/2607.28677)
...
### [44] [ViSAGE: Constructing Self-Correcting Memories for Long-Form Video Understanding](https://arxiv.org/abs/2607.28678)
...
### [45] [Multi-Agent Planning with Spatio-Temporal and Topological Constraints using STL-GO](https://arxiv.org/abs/2607.28679)
...
### [46] [Library Reachability in LSR-Synth: How Anti-Memorization Design Changes the Measurement of Symbolic Discovery](https://arxiv.org/abs/2607.28684)
...
### [48] [SciToolAgent-Evo: An Ontology-Aware Self-Evolving Agent for Open-World Scientific Tool Acquisition](https://arxiv.org/abs/2607.28692)
...
### [49] [EarlyDx: An Admission-Anchored Benchmark for Open-Ended Generation of Evidence-Supported ED-Encounter Diagnoses](https://arxiv.org/abs/2607.28788)
...
### [50] [Model or Harness? An Interaction-Centric Taxonomy for Localizing Agent Failures](https://arxiv.org/abs/2607.28802)
...
### [51] [Best Friends, Not Forever: Evaluating Long-Horizon Persona Collapse and Behavioral Drift in AI Companions](https://arxiv.org/abs/2607.28818)
...
### [53] [Identifying Informative Environments for Cognition Parameter Inference via Bayesian Experimental Design](https://arxiv.org/abs/2607.28894)
...
### [54] [NeSyFS: A Neuro-symbolic Fast-Slow Thinking Framework for LLM Agent under Partial Observability](https://arxiv.org/abs/2607.28942)
...
### [55] [MerchantBench: Benchmarking LLM Agents for Long-Term Coherence in E-Commerce Operations](https://arxiv.org/abs/2607.28956)
...
### [56] [Scaling Scientific Discovery Environments for Turn-Level Agentic RL](https://arxiv.org/abs/2607.28990)
...
### [57] [MMShopBench: A Real-Log Benchmark for Multimodal, Multi-Turn Shopping Agents](https://arxiv.org/abs/2607.29002)
...
### [58] [Evidence-Grounded Constraint Checking in Construction Documents](https://arxiv.org/abs/2607.29058)
...
### [59] [On the Generalization of Steering Vectors for Chain-of-Thought Faithfulness](https://arxiv.org/abs/2607.29062)
...
### [60] [A Generalized-Bayes Perspective on Counterfactual Explanations: Posterior-Based Decision-Making and Evaluation](https://arxiv.org/abs/2607.29077)
*Keita Kinjo*
...
### [61] [Harnessing the Wisdom of LLM Crowds through Complementarity-Driven Iterative Collaboration](https://arxiv.org/abs/2607.29087)
...
### [62] [CAGE: Certified Authorization under Typed-Return Uncertainty for Tool-Using Agents](https://arxiv.org/abs/2607.29190)
...
### [63] [MirrorCraft: Paired Evaluation under Hidden Rule Changes in Minecraft](https://arxiv.org/abs/2607.29218)
...
### [64] [Don't Mix Rewards, Mix Policies: Policy Decomposition and Optimization for Multi-Reward RL](https://arxiv.org/abs/2607.29246)
...
### [65] [Tool Specifications Matter: Uncovering and Mitigating Safety Risks in AI Agents](https://arxiv.org/abs/2607.29254)
...
### [66] [MAGA: Multi-Platform Self-Fusion of GUI Agents via Structured Action Distillation](https://arxiv.org/abs/2607.29320)
...
### [67] [Beyond Component Testing: Validating Agentic AI Systems](https://arxiv.org/abs/2607.29405)
...
### [68] [ModelEquivBench: Certifying Multi-Relational Evaluation of LLM-Generated Optimization Models](https://arxiv.org/abs/2607.29431)
...
### [69] [Beyond Retrieval: Analytic Memory for Multimodal Agents](https://arxiv.org/abs/2607.29440)
...
### [70] [Self-Play Meets Skill Evolution: Self-Evolving Search Agents that Pose, Solve, and Remember](https://arxiv.org/abs/2607.29468)
...
### [71] [AMTFV: Agentic Mathematical Tool-Flow Verification for LLM Self-Correction](https://arxiv.org/abs/2607.29549)
...
### [72] [COntExt: Towards Context-Aware Ontology Extension from Operational Metrics](https://arxiv.org/abs/2607.29553)
...
### [73] [LEMUR: Learning to Align with Multi-Objective Reinforcement Learning from Preference Feedback](https://arxiv.org/abs/2607.29559)
...
### [74] [DungeonBench: A Benchmark for Rules-Rich Tactical Reasoning in Dungeons & Dragons Combat](https://arxiv.org/abs/2607.29577)
...
### [75] [AgentHPOBench: A Benchmark For Evaluating LLM Agents as Sequential Hyperparameter Optimizers](https://arxiv.org/abs/2607.29626)
...
### [76] [Development of FDD-ON: an Ontology for VAV HVAC System Fault Detection and Diagnostics](https://arxiv.org/abs/2607.29657)
...
### [77] [ExtractBench: A Benchmark for Schema-Guided Enterprise Document Extraction](https://arxiv.org/abs/2607.29677)
