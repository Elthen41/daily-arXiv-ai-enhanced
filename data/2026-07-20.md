...
### [5] [Vogls: a Fast Interactive Full-timing Simulator for Pre-silicon Power Side-Channel Analysis](https://arxiv.org/abs/2607.15782)
...
### [6] [FLINT: Fingerprinting Federated Learning Architectures from 5G PHY-Layer Side Channels](https://arxiv.org/abs/2607.15469)
...
### [7] [From Neural Intent to Cryptographic Authorization: Governing Agentic Workflows](https://arxiv.org/abs/2607.15596)
...
### [8] [Do Agents Dream of False Memories? Black-box Visual Attacks on Long-term Memory in Multimodal AI Agents](https://arxiv.org/abs/2607.15657)
...
### [9] [Beyond Detection: Agentic Attack Synthesis and Simulation for Smart Contracts](https://arxiv.org/abs/2607.15673)
...
### [10] [Natural Backdoor Attacks on Speech Recognition Models](https://arxiv.org/abs/2607.15724)
...
### [11] [Ciphertext- and Polynomial-Level Optimization for Fully Homomorphic Encryption](https://arxiv.org/abs/2607.15750)
...
### [12] [DICOMHawk: A Cyber Deception Framework for Medical Imaging Infrastructure](https://arxiv.org/abs/2607.15754)
...
### [25] [Precise but Uncoupled: Reviewer Precision Does Not Guarantee Critique Uptake in Multi-Agent Math Reasoning](https://arxiv.org/abs/2607.15388)
...
### [26] [DrawingVQA: A Real-World Benchmark for Multi-Depth Visual-Textual Reasoning on Construction Drawings](https://arxiv.org/abs/2607.15418)
...
### [27] [Do Coding Agents Need Executable World Models, Simplification, and Verification to Solve ARC-AGI-3?](https://arxiv.org/abs/2607.15439)
*Sergey Rodionov*
...
### [28] [Beyond a Joke: Multi-Angle Reasoning for Detecting and Explaining Harmful Humor in Memes](https://arxiv.org/abs/2607.15442)
...
### [29] [From Black Box to Executable Logic: Explainable Reinforcement Learning through Prolog Expert Systems](https://arxiv.org/abs/2607.15459)
...
### [30] [A Critical Analysis of Trustworthy AI Tools, Mark Frameworks, and the Implementation Chasms](https://arxiv.org/abs/2607.15480)
...
### [31] [Logic, Optimization, and Artificial Intelligence](https://arxiv.org/abs/2607.15532)
*J. N. Hooker*
...
### [32] [SeerGuard: A Safety Framework for Mobile GUI Agents via World Model Prediction](https://arxiv.org/abs/2607.15550)
...
### [33] [MGDT: MLLM-Guided Diffusion Transformer with Relation-Adaptive Mixture-of-Experts for Multimodal Knowledge Graph Completion](https://arxiv.org/abs/2607.15592)
...
### [34] [Neuro-Symbolic AI for LEED compliance: Document-Centric Benchmarking, Deterministic Numeric Checking, and When Multimodal Hurts](https://arxiv.org/abs/2607.15647)
...
### [35] [ToolVerse: Unlocking Massive Environments and Long-Horizon Tasks for Agentic Reinforcement Learning](https://arxiv.org/abs/2607.15660)
...
### [36] [S1-Omni: A Unified Multimodal Reasoning Model for Scientific Understanding, Prediction, and Generation](https://arxiv.org/abs/2607.15686)
...
### [38] [NeurOWL: An LLM-Based Neural-symbolic Framework for Incomplete OWL Ontology Reasoning](https://arxiv.org/abs/2607.15776)
...
### [39] [AgentFAIR: A Multi-Agent Collaborative Framework for FAIRness Evaluation of Geospatial Datasets](https://arxiv.org/abs/2607.15781)
...
### [40] [Knowledge-Centric Agents for Workflow Generation](https://arxiv.org/abs/2607.15845)
...
### [41] [DSWorld: A Data Science World Model for Efficient Autonomous Agents](https://arxiv.org/abs/2607.15901)
...
### [42] [A Formally Grounded ODRL Evaluator: Implementation and Comparison](https://arxiv.org/abs/2607.15987)
...
### [43] [Closing the AI Trust Gap: The Case for Independent Certification for Trustworthy AI](https://arxiv.org/abs/2607.15992)
...
### [44] [SciForge: An AI-Native, Multimodal Workbench for Scientific Discovery](https://arxiv.org/abs/2607.16038)
...
### [45] [Harmonizing AI Safety Thresholds](https://arxiv.org/abs/2607.16112)
...
### [47] [RTL-Sequencer: Towards Scalable RTL Timing Prediction with the Sequence-based Paradigm](https://arxiv.org/abs/2607.15830)
...
### [48] [DSTAR: Accelerating Diffusion Transformers via Spatial and Temporal Redundancy Reduction](https://arxiv.org/abs/2607.15846)
...
### [49] [From Patterns to Parsers: Automatic Generation of Efficient Hardware Parsers for FPGAs](https://arxiv.org/abs/2607.16058)
...
### [50] [FSZ: Breaking the Prediction-Throughput Trade-off in GPU Lossy Compression](https://arxiv.org/abs/2607.15413)
*Jiajun Huang*
...
### [51] [Scalable LLM Agent Tool Access in the Cloud](https://arxiv.org/abs/2607.15593)
...
### [53] [Every Microsecond Matters: Achieving Near Speed-of-Light Latency in GPU Collectives](https://arxiv.org/abs/2607.16100)
