...
### [10] [Detecting and Mitigating Bias by Treating Fairness as a Symmetry Operation](https://arxiv.org/abs/2606.06514)
*Nishit Singh*
...
### [11] [DiBS: Diffusion-Informed Branch Selection](https://arxiv.org/abs/2606.06518)
...
### [12] [SafeGene: Reusable Adapters for Transferable Safety Alignment](https://arxiv.org/abs/2606.06519)
...
### [13] [Lean4Agent: Formal Modeling and Verification for Agent Workflow and Trajectory](https://arxiv.org/abs/2606.06523)
...
### [14] [CrowdMath: A Dataset of Crowdsourced Mathematical Research Discussions](https://arxiv.org/abs/2606.06526)
...
### [15] [Attack Selection in Agentic AI Control Evaluations Meaningfully Decreases Safety](https://arxiv.org/abs/2606.06529)
...
### [16] [CARVE-Q: Quantum-Proposed, Classically Certified Interactive Driving Repair](https://arxiv.org/abs/2606.06531)
*Yifan Wang*
...
### [17] [Position: Don't Just "Fix it in Post": A Science of AI Must Study Training Dynamics](https://arxiv.org/abs/2606.06533)
...
### [18] [Accelerated Fourier SAT (AFSAT): Fully Realising a GPU-based Symmetric Pseudo-Boolean SAT Solver](https://arxiv.org/abs/2606.06641)
...
### [19] [A Study of Parallel Continuous Local Search](https://arxiv.org/abs/2606.06656)
*Cody J Christopher,Charles Gretton*
...
### [20] [AEGIS: A Backup Reflex for Physical AI](https://arxiv.org/abs/2606.06660)
*Josef Chen*
...
### [21] [A Geometric Account of Activation Steering through Angle-Norm Decomposition](https://arxiv.org/abs/2606.06735)
...
### [22] [OpenSkill: Open-World Self-Evolution for LLM Agents](https://arxiv.org/abs/2606.06741)
...
### [23] [AdMem: Advanced Memory for Task-solving Agents](https://arxiv.org/abs/2606.06787)
...
### [24] [Evidence-Based Intelligent Diagnostic and Therapeutic Visualization System with Large Language Models: Multi-Turn Interaction and Multimodal Treatment Plan Generation](https://arxiv.org/abs/2606.06869)
...
### [25] [Workflow-to-Skill: Skill Creation via Routing-Workflow-Semantics-Attachments Decomposition](https://arxiv.org/abs/2606.06893)
...
### [26] [Declarative Skills for AI Agents in Knowledge-Grounded Tool-Use Workflows](https://arxiv.org/abs/2606.06923)
...
### [27] [Quantum-Inspired Trace-Augmented Evidence Selection for Reasoning over Structured Hypothesis Spaces](https://arxiv.org/abs/2606.06941)
...
### [28] [Accounting for Context: Shaping Moral Credences for Value Alignment](https://arxiv.org/abs/2606.06972)
...
### [29] [Exploring Agentic Tool-Calling Decisions via Uncertainty-Aligned Reinforcement Learning](https://arxiv.org/abs/2606.06976)
...
### [30] [Teaching the Way, Not the Answer: Privileged Tutoring Distillation for Multimodal Policy Optimization](https://arxiv.org/abs/2606.07000)
...
### [31] [The Sim-to-Real Gap of Foundation Model Agents: A Unified MDP Perspective](https://arxiv.org/abs/2606.07017)
...
### [32] [StainFlow: Entity-Stain Tracking and Evidence Linking for Process Rewards in GUI Agents](https://arxiv.org/abs/2606.07027)
...
### [33] [Hierarchical Semantic-Constrained Heterogeneous Graph for Audio-Visual Event Localization](https://arxiv.org/abs/2606.07033)
...
### [34] [Front-to-Attractors: Modifying the Front-to-Front Heuristic in Bidirectional Search](https://arxiv.org/abs/2606.07047)
...
### [35] [DyCon: Dynamic Reasoning Control via Evolving Difficulty Modeling](https://arxiv.org/abs/2606.07108)
...
### [36] [Beyond Post-hoc Explanation: Toward Glassbox AI via Probabilistic Mediation](https://arxiv.org/abs/2606.07113)
*Manuele Leonelli*
...
### [37] [Think Fast: Estimating No-CoT Task-Completion Time Horizons of Frontier AI Models](https://arxiv.org/abs/2606.07157)
...
### [38] [TOPSIS-RAD: Ranking According to Desires](https://arxiv.org/abs/2606.07253)
...
### [39] [DuMate-DeepResearch: An Auditable Multi-Agent System with Recursive Search and Rubric-Grounded Reasoning](https://arxiv.org/abs/2606.07299)
...
### [40] [Off-Policy Evaluation with Strategic Agents via Local Disclosure](https://arxiv.org/abs/2606.07308)
...
### [41] [Online Pandora's Box for Contextual LLM Cascading](https://arxiv.org/abs/2606.07392)
...
### [42] [Act As a Real Researcher: A Suite of Benchmarks Evaluating Frontier LLMs and Agentic Harnesses in Research Lifecycle](https://arxiv.org/abs/2606.07462)
...
### [43] [How AI Agents Reshape Knowledge Work: Autonomy, Efficiency, and Scope](https://arxiv.org/abs/2606.07489)
...
### [44] [StageFrontier: Synchronization-Aware Stage Accounting for Distributed ML Training](https://arxiv.org/abs/2606.06751)
...
### [45] [Terastal: Layer-Variant-based Scheduling for Real-Time Multi-DNN Workloads on Heterogeneous Accelerators](https://arxiv.org/abs/2606.06818)
...
### [46] [Communication Strategy Selection for Multi-GPU 3D FDTD with Convolutional Perfectly Matched Boundary Layers](https://arxiv.org/abs/2606.06910)
*Victory C. Obieke*
...
### [47] [PCCL: Process Group-Aware Scalable and Generic Collective Algorithm Synthesizer](https://arxiv.org/abs/2606.07019)
...
### [48] [Predictive Autoscaling in Cloud-Native and Federated Cloud-Edge Computing Environments: A Taxonomy and Future Directions](https://arxiv.org/abs/2606.07046)
...
### [49] [Clairvoyant: Predictive SJF Scheduling to Mitigate Head-of-Line Blocking in Serial LLM Backends](https://arxiv.org/abs/2606.07248)
*Aravind Sundaresan*
...
### [50] [Twelve quick tips for designing AI-driven HPC workflows](https://arxiv.org/abs/2606.07491)
*Jamie J. Alnasir*
...
### [51] [Enhancing Malware Detection with Generative AI: Using Variational Autoencoders to Boost Machine Learning Classifiers' Performance](https://arxiv.org/abs/2606.06501)
...
### [52] [Subtle Injection for Ground-truth Inference of LLM Training Data](https://arxiv.org/abs/2606.06502)
...
### [53] [MalTree: Tracing Malware Evolution from Embeddings at Scale](https://arxiv.org/abs/2606.06570)
...
### [54] [AgileOS: A GPU Operating System Layer for Protected CUDA Services](https://arxiv.org/abs/2606.06697)
...
### [55] [The Custody Envelope Threshold: Authority-Scaled Admission of External Artifacts in Institutional Infrastructure](https://arxiv.org/abs/2606.06767)
*Amadeus Brandes*
...
### [56] [What Your Posts Reveal: A Benchmark and Agentic Framework for User-Level Privacy Leakage on Social Media](https://arxiv.org/abs/2606.06784)
...
### [57] [AMD-FCG: An Enhanced Function Call Graph Dataset with Integrated Topological Features for Malware Detection and Classification](https://arxiv.org/abs/2606.06815)
...
### [58] [On the Incentive Compatibility of Block Propagation in Bitcoin](https://arxiv.org/abs/2606.06860)
...
### [59] [FDM: A Framework for Decision-making to build ML-based Malware detection systems](https://arxiv.org/abs/2606.06894)
...
### [60] [Blockchain Infrastructure for Intelligent Cyber--Physical--Social Systems:Post-Quantum Security, Interoperability, and Trustworthy Data Economies in the Era of Embodied AI](https://arxiv.org/abs/2606.06895)
...
### [61] [DPAgent-in-the-Middle: Agentic Defense and Repair Against AI-Groomed Deceptive Patterns](https://arxiv.org/abs/2606.06914)
...
### [62] [HAVE: Host Active Verification Engine for Closing the Contextual Reality Gap in Security Digital Twins](https://arxiv.org/abs/2606.06968)
...
### [63] [The Sound of Malware: A Memory Forensics Approach for Android Malware Analysis via Audio Signals](https://arxiv.org/abs/2606.07005)
...
### [64] [Fast Bounded-Independence Functions and Their Duals](https://arxiv.org/abs/2606.07009)
...
### [65] [MalSkillBench: A Runtime-Verified Benchmark of Malicious Agent Skills](https://arxiv.org/abs/2606.07131)
...
### [66] [From Privacy to Workflow Integrity: Communication-Graph Metadata in Autonomous Agent Interoperability](https://arxiv.org/abs/2606.07150)
*Bijaya Dangol*
...
### [67] [Synthetic APTs: the Collapse of TTP-Based Attribution](https://arxiv.org/abs/2606.07158)
...
### [68] [Rethinking IoT Intrusion Detection: Augmenting Routing Metrics with Radio Features](https://arxiv.org/abs/2606.07282)
...
### [69] [Authorized and Verifiable Searchable Encryption Based on Public Key Equality Test for Cloud Storage](https://arxiv.org/abs/2606.07319)
...
### [70] [Defending Jailbreak Attacks on Large Language Models via Manifold Trajectory Kinetics](https://arxiv.org/abs/2606.07335)
...
### [71] [Empirical Evaluation of Large Language Models for Migration of Code Fragments to Post-Quantum Cryptography](https://arxiv.org/abs/2606.07341)
...
### [72] [On the Shoulders of Giants: Empowering Automated Smart Contract Auditing via the GiAnt Corpus](https://arxiv.org/abs/2606.07363)
...
### [73] [Lost in Migration: Exposing Android Framework Vulnerabilities in Parallel Java-Kotlin Implementations](https://arxiv.org/abs/2606.07420)
...
### [74] [Verifiable and Confidential DNN Inference on Low-End Edge Devices](https://arxiv.org/abs/2606.07470)
...
### [75] [Zero-Shot Embedding Drift Detection: A Lightweight Defense Against Prompt Injections in LLMs](https://arxiv.org/abs/2601.12359)
