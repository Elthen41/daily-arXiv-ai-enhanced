...
### [26] [Shooting Neutrons at Neurons: Radiation Testing of a Spiking Neural Network on Flash-Based FPGAs](https://arxiv.org/abs/2605.00030)
...
### [27] [ROSA: Robust and Energy-Efficient Microring-Based Optical Neural Networks via Optical Shift-and-Add and Layer-Wise Hybrid Mapping](https://arxiv.org/abs/2605.00032)
...
### [28] [Lottery BP: Unlocking Quantum Error Decoding at Scale](https://arxiv.org/abs/2605.00038)
...
### [29] [Autoformalizing Memory Specifications with Agents](https://arxiv.org/abs/2605.00058)
...
### [30] [DPU or GPU for Accelerating Neural Networks Inference -- Why not both? Split CNN Inference](https://arxiv.org/abs/2605.00174)
...
### [31] [A PVT-Resilient Subthreshold SRAM-Based In-Memory Computing Accelerator with In-Situ Regulation for Energy-Efficient Spiking Neural Networks](https://arxiv.org/abs/2605.00319)
...
### [32] [VitaLLM: A Versatile and Tiny Accelerator for Mixed-Precision LLM Inference on Edge Devices](https://arxiv.org/abs/2605.00320)
...
### [33] [Sim-FA: A Simulator Frontend for Asynchronous Pipelines](https://arxiv.org/abs/2605.00555)
...
### [34] [Replication in Graph Partitioning and Scheduling Problems](https://arxiv.org/abs/2605.00209)
...
### [35] [Adaptation of AI-accelerated CFD Simulations to the IPU platform](https://arxiv.org/abs/2605.00462)
...
### [36] [Space Network of Experts: Architecture and Expert Placement](https://arxiv.org/abs/2605.00515)
...
### [37] [SAGA: Workflow-Atomic Scheduling for AI Agent Inference on GPU Clusters](https://arxiv.org/abs/2605.00528)
...
### [38] [Tempus: A Temporally Scalable Resource-Invariant GEMM Streaming Framework for Versal AI Edge](https://arxiv.org/abs/2605.00536)
...
### [39] [LLM-Emu: Native Runtime Emulation of LLM Inference via Profile-Driven Sampling](https://arxiv.org/abs/2605.00616)
...
### [40] [Eliminating Hidden Serialization in Multi-Node Megakernel Communication](https://arxiv.org/abs/2605.00686)
...
### [51] [AEM: Adaptive Entropy Modulation for Multi-Turn Agentic Reinforcement Learning](https://arxiv.org/abs/2605.00425)
...
### [53] [On the Role of Artificial Intelligence in Human-Machine Symbiosis](https://arxiv.org/abs/2605.00440)
...
### [54] [Instance-Aware Parameter Configuration in Bilevel Late Acceptance Hill Climbing for the Electric Capacitated Vehicle Routing Problem](https://arxiv.org/abs/2605.00572)
...
### [55] [Learn where to Click from Yourself: On-Policy Self-Distillation for GUI Grounding](https://arxiv.org/abs/2605.00642)
...
### [56] [To Call or Not to Call: A Framework to Assess and Optimize LLM Tool Calling](https://arxiv.org/abs/2605.00737)
...
### [57] [Position: agentic AI orchestration should be Bayes-consistent](https://arxiv.org/abs/2605.00742)
