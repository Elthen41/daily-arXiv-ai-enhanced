...
### [36] [Fair on the Surface: Transaction-Ordering Bias and MEV in Mysticeti DAG-based BFT Protocol](https://arxiv.org/abs/2607.13378)
...
### [40] [The Entanglement Wall: Activation-Space Probes as Risk Detectors, Not Context Adjudicators](https://arxiv.org/abs/2607.13075)
*Dominik Schwarz*
...
### [41] [Operational Evidence Gaps for LLMs in Fraud Detection and Trust-and-Safety Workflows](https://arxiv.org/abs/2607.13078)
*Keyur Gabani*
...
### [42] [SingGuard-NSFA: Extensible Guardrails for Agentic AI via Generative Reasoning and Real-Time Classification](https://arxiv.org/abs/2607.13081)
*SingGuard Team*
...
### [43] [Beyond AI-Generated Labels: Watermarking, Co-Creation, and Conflation of AI-Generation with Disinformation](https://arxiv.org/abs/2607.13082)
...
### [44] [Phantom Guardrails: When Self-Improving Agent Harnesses Fix Failures That Never Happened](https://arxiv.org/abs/2607.13083)
...
### [45] [Baselines Before Architecture: Evaluating Coding Agents for Autonomous Penetration Testing](https://arxiv.org/abs/2607.13085)
...
### [46] [GDM AI Control Roadmap](https://arxiv.org/abs/2607.13087)
...
### [47] [Securing LLMs in the Wild: Privacy and Security Challenges at the Edge](https://arxiv.org/abs/2607.13088)
...
### [48] [Efficient and Privacy Aware Edge Cloud Collaborative Inference for Large Language Models](https://arxiv.org/abs/2607.13093)
...
### [50] [Designing a GDPR-Compliant Security Architecture for Remote Elderly Care Systems: A Privacy-by-Design Approach](https://arxiv.org/abs/2607.13122)
...
### [51] [AI in Cyberpsychology: A systematic literature review of Cybersecurity enhancement by using AI for analyzing psychology of Victims, Attackers, and Defenders](https://arxiv.org/abs/2607.13123)
...
### [52] [Composable Trust for Language Models: A proven boundary and a measured defense](https://arxiv.org/abs/2607.13149)
...
### [53] [BARS: Benign-Anchored Ranking and Selection for False Alarm Reduction in Network Intrusion Detection](https://arxiv.org/abs/2607.13203)
...
### [54] [CODA: How to Mitigate ColumnDisturb for (Almost) Free?](https://arxiv.org/abs/2607.13505)
*Moinuddin Qureshi*
...
### [55] [Why Not Fix It Once and for All? An Empirical Study of Multiple Patches for Vulnerability Fixes in Open-Source Software](https://arxiv.org/abs/2607.13206)
...
### [56] [Proof in a Bottle: Long-Lived Verifiable Secret Sharing via Pre-Quantum Commitment and Immutable Ledger Binding](https://arxiv.org/abs/2607.13235)
...
### [57] [Privacy Preserving Recommender Systems Balancing Personalization with Privacy](https://arxiv.org/abs/2607.13328)
...
### [58] [The Refusal Residue: When Probes Catch Alignment Faking and When They Don't](https://arxiv.org/abs/2607.13346)
*Aman Mehta*
...
### [59] [xChk: Bring Your Own Identity -- Heterogeneous Assurance with Verifier-Determined Sufficiency](https://arxiv.org/abs/2607.13369)
*Sean MacGuire*
...
### [60] [Evaluating Frontier AI Agents as Autonomous Clinical Security Auditors](https://arxiv.org/abs/2607.13411)
*Michael O. Eniolade*
...
### [61] [DREA: Decoupled Reasoning and Exploration Agents for Repository-Level Vulnerability Detection](https://arxiv.org/abs/2607.13439)
...
### [62] [ε-Indistinguishability In Moving Target Defense: Framework, Algorithms, And Cloud Case Studies](https://arxiv.org/abs/2607.13440)
...
### [63] [ReBound: Reuse-Aware Privacy For Interactive Decision Support](https://arxiv.org/abs/2607.13441)
...
### [64] [Adversarial Prompting Framework for AI Safety Assessment](https://arxiv.org/abs/2607.13453)
...
### [65] [To Play or Not to Play: Insights and Lessons Learned from 20 Years of CTFs with ENOFLAG](https://arxiv.org/abs/2607.13480)
...
### [66] [When T2I Synthetic Data Backfires: Amplified Privacy Risks in Real-Synthetic Mix Training](https://arxiv.org/abs/2607.13541)
...
### [67] [Multivariate Cryptography-Based Anonymous Certificate Scheme](https://arxiv.org/abs/2607.13554)
*Abel C. H. Chen*
...
### [68] [UTS at ELOQUENT 2026 Voight-Kampff: structural shifts in AI writing bypass state-of-the-art detectors](https://arxiv.org/abs/2607.13565)
...
### [69] [Protective Capacity Hallucination: When Large Language Models Claim Nonexistent Capabilities](https://arxiv.org/abs/2607.13596)
...
### [70] [WarpGuard: Towards Control-Flow Attestation for Heterogeneous CPU-GPU Execution](https://arxiv.org/abs/2607.13640)
...
### [71] [How Agents Ask for Permission: User Permissions for AI Agents, from Interfaces to Enforcement](https://arxiv.org/abs/2607.13718)
...
### [72] [PriEval-Protect: A Unified Framework for Privacy Evaluation and Protection in Healthcare Systems](https://arxiv.org/abs/2607.13754)
...
### [73] [Traffic-Aware Randomized Smoothing for LLM-Based Network Intrusion Detection](https://arxiv.org/abs/2607.13801)
*Zhenpeng Li*
...
### [74] [Assessing the Forensic Viability of Android Memory Analysis Across Production Builds: A Cross-Version Study of Security Hardening and Structure Preservation](https://arxiv.org/abs/2607.13821)
...
### [75] [Reveal, Correct, Then Pay: Encrypted Mempools and Perpetual Funding Security](https://arxiv.org/abs/2607.13832)
*Benjamin Marsh*
...
### [76] [From Classification to Consistent Templates: Multiple Permuted-Label Classifier Encoding for Biometric Template Protection](https://arxiv.org/abs/2607.13845)
...
### [77] [Plausible Deniability Guarantees for Whistleblowers](https://arxiv.org/abs/2607.13928)
...
### [78] [HORCRUX: A Complete PQC RISC-V eXtension Architecture](https://arxiv.org/abs/2607.13939)
...
### [79] [Agent Skill Security: Threat Models, Attacks, Defenses, and Evaluation](https://arxiv.org/abs/2607.13987)
...
### [80] [Rethinking Penetration Testing for AI-Enabled Systems: From Resource Compromise to Behavioral Objective Violation](https://arxiv.org/abs/2607.14006)
...
### [81] [The Economics of AI Decoding Chips: Rebalancing Compute, Capacity, and Bandwidth for Efficient LLM Inference](https://arxiv.org/abs/2607.13068)
...
### [82] [ChipVerilog: A Large-Scale OpenCores-Derived Benchmark for LLM-Based Verilog RTL Generation](https://arxiv.org/abs/2607.13079)
...
### [83] [Full-Pipeline Inference Optimization for MiMo-V2.5 Series: Pushing Hybrid SWA Efficiency to the Limit](https://arxiv.org/abs/2607.13095)
...
### [84] [No Attention, No Problem: DPU-Aware Attention Approximation in Modern YOLO on FPGA](https://arxiv.org/abs/2607.13106)
...
### [85] [Microflow: Microarchitectural Causal Observability for Deep Cross-Layer Analysis and Optimization](https://arxiv.org/abs/2607.13184)
...
### [86] [A Reality Check on Quantum Optimisation: Evidence from an Industrial Case Study](https://arxiv.org/abs/2607.13325)
...
### [87] [CIMERA: Compute-in-Interconnect and Memory with Reconfigurable Precision for LLM Inference](https://arxiv.org/abs/2607.13649)
...
### [88] [Kaleido: Algorithm-Hardware Co-Design for Video Diffusion Transformers by Exploiting Latent Space Correlations](https://arxiv.org/abs/2607.13770)
...
### [89] [Jack of All Scales: A Versatile FPGA Tensor Block for MXFP Precisions](https://arxiv.org/abs/2607.13898)
