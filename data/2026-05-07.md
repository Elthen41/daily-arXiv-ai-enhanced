...
### [27] [Resource Utilization of Differentiable Logic Gate Networks Deployed on FPGAs](https://arxiv.org/abs/2605.04109)
...
### [28] [täkōFormal: Enabling Robust Software for Programmable Memory Hierarchies (Extended Version)](https://arxiv.org/abs/2605.04172)
...
### [29] [The Anatomy of Silent Data Corruption: GPU Error Pattern Study and Modeling Guidance](https://arxiv.org/abs/2605.04213)
...
### [30] [RangeGuard: Efficient, Bounded Approximate Error Correction for Reliable DNNs](https://arxiv.org/abs/2605.04563)
...
### [31] [Ultra Low-Power SDM-based Circuit-Switching for Networks-on-Chip](https://arxiv.org/abs/2605.04679)
...
### [32] [UVMarvel: an Automated LLM-aided UVM Machine for Subsystem-level RTL Verification](https://arxiv.org/abs/2605.04704)
...
### [33] [Not All Faults Are Equal: Transient-Fault Sensitivity Characterization of an Open-Source RISC-V Vector Cluster](https://arxiv.org/abs/2605.04803)
...
### [34] [MCFlash: Bulk Bitwise Processing in 3D NAND with Dynamic Sensing and Multi-level Encoding](https://arxiv.org/abs/2605.05119)
...
### [35] [Membership Inference Attacks for Retrieval Based In-Context Learning for Document Question Answering](https://arxiv.org/abs/2605.04116)
...
### [36] [Quantum-Resistant Networks: A Review of Primitives, Protocols and Best Practices](https://arxiv.org/abs/2605.04129)
...
### [37] [Undetectable Backdoors in Model Parameters: Hiding Sparse Secrets in High Dimensions](https://arxiv.org/abs/2605.04209)
...
### [38] [Towards a Zero-Trust Supply-Chain Assurance Rubric for ORAN RIC Applications](https://arxiv.org/abs/2605.04249)
*Chun Yin Chiu*
...
### [39] [Binary Image-Based Intrusion Detection for Operational Technology Networks: Extending the SPHBI Methodology from IoT to Modbus TCP](https://arxiv.org/abs/2605.04250)
*Aamir Omar*
...
### [40] [Root-Cause-Driven Automated Vulnerability Repair](https://arxiv.org/abs/2605.04251)
...
### [41] [Lightweight Vulnerability Detection from Code Metrics and Token Features](https://arxiv.org/abs/2605.04260)
*Chun Yin Chiu*
...
### [42] [Laundering AI Authority with Adversarial Examples](https://arxiv.org/abs/2605.04261)
...
### [43] [Revocation-Ready CP-ABE Key Management for Blockchain-Based IoT Data Sharing](https://arxiv.org/abs/2605.04280)
*Chun Yin Chiu*
...
### [44] [Assessing Generalisation Capability of Machine Learning Models for Intrusion Detection](https://arxiv.org/abs/2605.04407)
...
### [45] [Misrouter: Exploiting Routing Mechanisms for Input-Only Attacks on Mixture-of-Experts LLMs](https://arxiv.org/abs/2605.04446)
...
### [46] [Order Flow Exclusivity and Value Extraction Mechanisms: An Analysis of Ethereum Builder Centralization](https://arxiv.org/abs/2605.04471)
...
### [47] [Pen-Strategist: A Reasoning Framework for Penetration Testing Strategy Formation and Analysis](https://arxiv.org/abs/2605.04499)
...
### [48] [PINSIGHT: A Comprehensive Threat Exploration of Domain-Adaptive Wi-Fi based PIN Code Inference](https://arxiv.org/abs/2605.04570)
...
### [49] [Securing the Web with HSTS-Enforced](https://arxiv.org/abs/2605.04642)
...
### [50] [Gray-Box Poisoning of Continuous Malware Ingestion Pipelines](https://arxiv.org/abs/2605.04698)
...
### [51] [Sparse Tokens Suffice: Jailbreaking Audio Language Models via Token-Aware Gradient Optimization](https://arxiv.org/abs/2605.04700)
...
### [52] [Vol-Mark: A Watermark for 3D Medical Volume Data Via Cubic Difference Expansion and Contrastive Learning](https://arxiv.org/abs/2605.04705)
...
### [53] [From Beats to Breaches:How Offensive AI Infers Sensitive User Information from Playlists](https://arxiv.org/abs/2605.04724)
...
### [54] [AFL-ICP: Enhancing Industrial Control Protocol Reliability via Specification-Guided Fuzzing](https://arxiv.org/abs/2605.04760)
...
### [55] [Long-Term Risks of IoT Devices: The Case of the Smart Fridge](https://arxiv.org/abs/2605.04787)
*Erik Buchmann*
...
### [56] [On the (In-)Security of the Shuffling Defense in the Transformer Secure Inference](https://arxiv.org/abs/2605.04901)
...
### [57] [Probabilistic Atomic Swaps for Bitcoin and Friends](https://arxiv.org/abs/2605.04975)
...
### [58] [You Snooze, You Lose: Automatic Safety Alignment Restoration through Neural Weight Translation](https://arxiv.org/abs/2605.04992)
...
### [59] [SoK: Robustness in Large Language Models against Jailbreak Attacks](https://arxiv.org/abs/2605.05058)
...
### [60] [Interpreting Manifolds and Graph Neural Embeddings from Internet of Things Traffic Flows](https://arxiv.org/abs/2602.05817)
...
### [61] [Constraint-Aware Execution Planning for Hybrid Space-Ground Compute Workloads](https://arxiv.org/abs/2605.04052)
*Subhadip Mitra*
...
### [62] [Microbenchmark-Driven Analytical Performance Modeling Across Modern GPU Architectures](https://arxiv.org/abs/2605.04178)
...
### [63] [phys-MCP: A Control Plane for Heterogeneous Physical Neural Networks](https://arxiv.org/abs/2605.04256)
...
### [64] [ClusterLess: Deadline-Aware Serverless Workflow Orchestration on Federated Edge Clusters](https://arxiv.org/abs/2605.04310)
...
### [65] [Orchestrating Serverless Applications in the Edge Cloud Space Continuum: What Breaks and What is Next?](https://arxiv.org/abs/2605.04316)
...
### [66] [Coral: Cost-Efficient Multi-LLM Serving over Heterogeneous Cloud GPUs](https://arxiv.org/abs/2605.04357)
...
### [67] [One Pool, Two Caches: Adaptive HBM Partitioning for Accelerating Generative Recommender Serving](https://arxiv.org/abs/2605.04450)
...
### [68] [CCL-D: A High-Precision Diagnostic System for Slow and Hang Anomalies in Large-Scale Model Training](https://arxiv.org/abs/2605.04478)
...
### [69] [Delay-Aware Large-Small Model Collaboration over LEO Satellite Networks](https://arxiv.org/abs/2605.04565)
...
### [70] [Communication Offloading on SmartNIC DPUs: A Quantitative Approach](https://arxiv.org/abs/2605.04842)
...
### [71] [Piper: Efficient Large-Scale MoE Training via Resource Modeling and Pipelined Hybrid Parallelism](https://arxiv.org/abs/2605.05049)
...
### [72] [Toward a Risk Assessment Framework for Institutional DeFi: A Nine-Dimension Approach](https://arxiv.org/abs/2605.05145)
