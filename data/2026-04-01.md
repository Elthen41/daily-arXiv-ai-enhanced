...
### [4] [Ray Tracing Cores for General-Purpose Computing: A Literature Review](https://arxiv.org/abs/2603.28771)
...
### [5] [Toward a Universal GPU Instruction Set Architecture: A Cross-Vendor Analysis of Hardware-Invariant Computational Primitives in Parallel Processors](https://arxiv.org/abs/2603.28793)
...
### [8] [A Framework for Hybrid Collective Inference in Distributed Sensor Networks](https://arxiv.org/abs/2603.28778)
...
### [9] [Byzantine-Robust and Communication-Efficient Distributed Training: Compressive and Cyclic Gradient Coding](https://arxiv.org/abs/2603.28780)
...
### [10] [When GPUs Fail Quietly: Observability-Aware Early Warning Beyond Numeric Telemetry](https://arxiv.org/abs/2603.28781)
...
### [11] [Comprehensive Plugin-Based Monitoring of Nexflow Workflow Executions](https://arxiv.org/abs/2603.28783)
...
### [25] [AP-DRL: A Synergistic Algorithm-Hardware Framework for Automatic Task Partitioning of Deep Reinforcement Learning on Versal ACAP](https://arxiv.org/abs/2603.29369)
...
### [26] [CXLRAMSim v1.0: System-Level Exploration of CXL Memory Expander Cards](https://arxiv.org/abs/2603.29483)
...
### [27] [HLC: A High-Quality Lightweight Mezzanine Codec Featuring High-Throughput Palette](https://arxiv.org/abs/2603.29864)
...
### [28] [SISA: A Scale-In Systolic Array for GEMM Acceleration](https://arxiv.org/abs/2603.29913)
...
### [61] [Beyond the Steeper Curve: AI-Mediated Metacognitive Decoupling and the Limits of the Dunning-Kruger Metaphor](https://arxiv.org/abs/2603.29681)
*Christopher Koch*
...
### [62] [A First Step Towards Even More Sparse Encodings of Probability Distributions](https://arxiv.org/abs/2603.29691)
...
### [63] [Measuring the metacognition of AI](https://arxiv.org/abs/2603.29693)
...
### [64] [Symphony for Medical Coding: A Next-Generation Agentic System for Scalable and Explainable Medical Coding](https://arxiv.org/abs/2603.29709)
...
### [65] [Reinforced Reasoning for End-to-End Retrosynthetic Planning](https://arxiv.org/abs/2603.29723)
...
### [66] [Spontaneous Functional Differentiation in Large Language Models: A Brain-Like Intelligence Economy](https://arxiv.org/abs/2603.29735)
*Junjie Zhang,Zhen Shen,Gang Xiong,Xisong Dong*
...
### [67] [CausalPulse: An Industrial-Grade Neurosymbolic Multi-Agent Copilot for Causal Diagnostics in Smart Manufacturing](https://arxiv.org/abs/2603.29755)
...
### [68] [Tracking vs. Deciding: The Dual-Capability Bottleneck in Searchless Chess Transformers](https://arxiv.org/abs/2603.29761)
...
### [69] [Reasoning-Driven Synthetic Data Generation and Evaluation](https://arxiv.org/abs/2603.29791)
...
### [70] [Owl-AuraID 1.0: An Intelligent System for Autonomous Scientific Instrumentation and Scientific Data Analysis](https://arxiv.org/abs/2603.29828)
...
### [77] [Uncertainty Gating for Cost-Aware Explainable Artificial Intelligence](https://arxiv.org/abs/2603.29915)
...
### [82] [The Triadic Cognitive Architecture: Bounding Autonomous Action via Spatio-Temporal and Epistemic Friction](https://arxiv.org/abs/2603.30031)
*Davide Di Gioia*
...
### [85] [SkillTester: Benchmarking Utility and Security of Agent Skills](https://arxiv.org/abs/2603.28815)
...
### [86] [GUARD-SLM: Token Activation-Based Defense Against Jailbreak Attacks for Small Language Models](https://arxiv.org/abs/2603.28817)
...
### [87] [SNEAKDOOR: Stealthy Backdoor Attacks against Distribution Matching-based Dataset Condensation](https://arxiv.org/abs/2603.28824)
...
### [88] [GMA-SAWGAN-GP: A Novel Data Generative Framework to Enhance IDS Detection Performance](https://arxiv.org/abs/2603.28838)
...
### [89] [Differential Privacy for Symbolic Trajectories via the Permute-and-Flip Mechanism](https://arxiv.org/abs/2603.28903)
...
### [90] [Privacy Guard & Token Parsimony by Prompt and Context Handling and LLM Routing](https://arxiv.org/abs/2603.28972)
*Alessio Langiu*
...
### [91] [KAN-LSTM: Benchmarking Kolmogorov-Arnold Networks for Cyber Security Threat Detection in IoT Networks](https://arxiv.org/abs/2603.28985)
*Mohammed Hassanin*
...
### [92] [Attesting LLM Pipelines: Enforcing Verifiable Training and Release Claims](https://arxiv.org/abs/2603.28988)
...
### [93] [Design Principles for the Construction of a Benchmark Evaluating Security Operation Capabilities of Multi-agent AI Systems](https://arxiv.org/abs/2603.28998)
...
### [94] [Trojan-Speak: Bypassing Constitutional Classifiers with No Jailbreak Tax via Adversarial Finetuning](https://arxiv.org/abs/2603.29038)
...
### [95] [CivicShield: A Cross-Domain Defense-in-Depth Framework for Securing Government-Facing AI Chatbots Against Multi-Turn Adversarial Attacks](https://arxiv.org/abs/2603.29062)
...
### [96] [Uncovering Relationships between Android Developers, User Privacy, and Developer Willingness to Reduce Fingerprinting Risks](https://arxiv.org/abs/2603.29063)
...
### [97] [Downsides of Smartness Across Edge-Cloud Continuum in Modern Industry](https://arxiv.org/abs/2603.29289)
...
### [98] [Beyond Corner Patches: Semantics-Aware Backdoor Attack in Federated Learning](https://arxiv.org/abs/2603.29328)
...
### [99] [Deep Learning-Assisted Improved Differential Fault Attacks on Lightweight Stream Ciphers](https://arxiv.org/abs/2603.29382)
...
### [100] [Security in LLM-as-a-Judge: A Comprehensive SoK](https://arxiv.org/abs/2603.29403)
...
### [101] [TrafficMoE: Heterogeneity-aware Mixture of Experts for Encrypted Traffic Classification](https://arxiv.org/abs/2603.29520)
...
### [102] [Mean Masked Autoencoder with Flow-Mixing for Encrypted Traffic Classification](https://arxiv.org/abs/2603.29537)
...
### [103] [5G Puppeteer: Chaining Hidden Command and Control Channels in 5G Core Networks](https://arxiv.org/abs/2603.29636)
...
### [104] [An Empirical Comparison of Security and Privacy Characteristics of Android Messaging Apps](https://arxiv.org/abs/2603.29668)
...
### [105] [Client-Verifiable and Efficient Federated Unlearning in Low-Altitude Wireless Networks](https://arxiv.org/abs/2603.29688)
...
### [106] [HPCCFA: Leveraging Hardware Performance Counters for Control Flow Attestation](https://arxiv.org/abs/2603.29749)
...
### [107] [Security and Privacy in Virtual and Robotic Assistive Systems: A Comparative Framework](https://arxiv.org/abs/2603.29907)
*Nelly Elsayed*
...
### [108] [Architecting Secure AI Agents: Perspectives on System-Level Defenses Against Indirect Prompt Injection Attacks](https://arxiv.org/abs/2603.30016)
...
### [109] [EnsembleSHAP: Faithful and Certifiably Robust Attribution for Random Subspace Method](https://arxiv.org/abs/2603.30034)
