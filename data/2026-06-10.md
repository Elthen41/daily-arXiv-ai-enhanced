...
### [61] [Hardware-accelerated Aggregation: Unification and Specialization](https://arxiv.org/abs/2606.10030)
...
### [62] [RATrain: A Resource-Aware Training Runtime for Large Language Models on Bandwidth-Constrained Heterogeneous Supercomputing Platforms](https://arxiv.org/abs/2606.10415)
...
### [63] [ASTRA-sim 3.0: Next-Level Distributed Machine Learning Simulations via High-Fidelity GPU and Infrastructure Modeling](https://arxiv.org/abs/2606.10440)
...
### [64] [Achieving Cloud-Grade SLOs for Local Mixture-of-Experts Inference through CPU-GPU Hybrid Design](https://arxiv.org/abs/2606.10493)
...
### [65] [Generalizing LCL Complexity Gaps to Unbounded Degree via Monadic Second-Order Properties](https://arxiv.org/abs/2606.10693)
*Chiara Piombi*
...
### [66] [Dynamic Software Updates using CRDTs](https://arxiv.org/abs/2606.10920)
...
### [67] [FairWave : A Fairness-Aware Asynchronous DAG-BFT Consensus](https://arxiv.org/abs/2606.10982)
*Syariful Mujaddiq*
...
### [68] [A Neurosymbolic Prolog Skill for LLM-Driven Service Placement](https://arxiv.org/abs/2606.11113)
...
### [69] [Revisiting "Cooler is Better": ITD-Aware Per-CPU Thermal Optimization for Sustainable Data Center Operation](https://arxiv.org/abs/2606.11163)
...
### [70] [Piper: A Programmable Distributed Training System](https://arxiv.org/abs/2606.11169)
...
### [71] [Safecloud: A Distributed, Encrypted Storage Cloud for Streaming](https://arxiv.org/abs/2606.09870)
*Gregory Magarshak*
...
### [72] [IDP-Bench: Benchmarking ability of LLMs to protect personal information in interdependent privacy contexts](https://arxiv.org/abs/2606.09908)
...
### [73] [Bypassing Copyright Protection in Diffusion-based Customization via Two-Stage Latent Feature Optimization](https://arxiv.org/abs/2606.09909)
...
### [74] [GitInject: Real-World Prompt Injection Attacks in AI-Powered CI/CD Pipelines](https://arxiv.org/abs/2606.09935)
...
### [75] [The Chronicles of Radio Frequency Fingerprinting](https://arxiv.org/abs/2606.10031)
...
### [76] [The Human Vulnerabilities & Exploits (HVE) Framework](https://arxiv.org/abs/2606.10083)
...
### [77] [SoK: Colluding Adversaries in Machine Learning Pipelines](https://arxiv.org/abs/2606.10091)
...
### [78] [Secrets Best Not Shared: DNS Privacy Enhancements for the Constrained IoT](https://arxiv.org/abs/2606.10097)
...
### [79] [RadKey: An LLM-Guided RF Backscatter System for Through-Wall Keystroke Inference](https://arxiv.org/abs/2606.10148)
...
### [80] [GRAFT: Graphlet-Triggered Backdoor Attack on GNN-Based Hardware Security Systems](https://arxiv.org/abs/2606.10163)
...
### [81] [Proof of Source of Funds: Efficient On-chain Provenance of Cryptoassets](https://arxiv.org/abs/2606.10172)
...
### [82] [A Hybrid Edge-Cloud Architecture for Low-Latency Entitlement Verification in Resource-Constrained Devices](https://arxiv.org/abs/2606.10536)
...
### [83] [Local Is Not a Sufficient Privacy Boundary: Governing OS-Integrated On-Device AI](https://arxiv.org/abs/2606.10173)
...
### [84] [RECON: An LLM-Enhanced Backward Constraint Analysis Framework](https://arxiv.org/abs/2606.10264)
...
### [85] [Benchmarking and Exploring the Capabilities of LLMs for Attack Investigations](https://arxiv.org/abs/2606.10281)
...
### [86] [The Linux IOCTL Census: A Source-Derived Database of the Linux Kernel Control-Code Surface](https://arxiv.org/abs/2606.10290)
*Michael J. Bommarito*
...
### [87] [Game-Theoretic Multi-Agent Control for Robust Contextual Reasoning in LLMs](https://arxiv.org/abs/2606.10322)
...
### [88] [Semantic Multi-Agent Intrusion Detection for IoT:Zero-Day and Adversarial Threats with Risk-Aware Reasoning](https://arxiv.org/abs/2606.10323)
*Saeid Jamshidi*
...
### [89] [The Distributed Detectability Band Against Marginal-Preserving Attacks](https://arxiv.org/abs/2606.10456)
...
### [90] [HE-DAP: Homomorphic Encryption-based Dynamic Adaptive Parameter Optimization for Statistical Computation](https://arxiv.org/abs/2606.10477)
...
### [91] [AgentCanary: A Security Evaluation Framework for Autonomous AI Agents in Real Executable Environments](https://arxiv.org/abs/2606.10484)
...
### [92] [When VR Meets BCI: (Un)Observable Brainwave-aware Privacy Reconstruction in the Metaverse via Unrestricted Inbuilt Motion Sensors](https://arxiv.org/abs/2606.10502)
...
### [93] [A Deployment-Oriented Framework for Explainable AI-Assisted eBPF/XDP Mitigation at the IoT Edge](https://arxiv.org/abs/2606.10508)
*Abdurrahman Tolay*
...
### [94] [Assessing Automated Prompt Injection Attacks in Agentic Environments](https://arxiv.org/abs/2606.10525)
...
### [95] [From Data Heterogeneity to Convergence: A Data-Centric Review of Federated Learning](https://arxiv.org/abs/2606.10595)
...
### [96] [Two-Way Confidential VMs (2cVM): Collaborative Confidential Computing for Mutually Distrustful Parties](https://arxiv.org/abs/2606.10615)
...
### [97] [snaproot: Decentralized File Integrity Verification Using Blockchain-Anchored Cryptographic Hashing](https://arxiv.org/abs/2606.10625)
...
### [98] [Layer Order Semantics for Automata-Based Cybersecurity](https://arxiv.org/abs/2606.10649)
...
### [99] [Post-Quantum Secure Federated DeFi for Inclusive Banking](https://arxiv.org/abs/2606.10658)
...
### [100] [Do LLMsMakeNeural Distinguishers Wise?](https://arxiv.org/abs/2606.10692)
...
### [101] [Fingerprinting All AI Cluster I/O Without Mutually Trusted Processors](https://arxiv.org/abs/2606.10724)
...
### [102] [MemVenom: Triggered Poisoning of Multimodal Memories in Web Agents](https://arxiv.org/abs/2606.10742)
...
### [103] [Toward Secure LLM Agents: Threat Surfaces, Attacks, Defenses, and Evaluation](https://arxiv.org/abs/2606.10749)
...
### [104] [A Bayesian Network Approach for Enhancing Security-Focused Decision Support Systems](https://arxiv.org/abs/2606.10782)
...
### [105] [RedAct: Redacting Agent Capability Traces for Procedural Skill Protection](https://arxiv.org/abs/2606.10813)
...
### [106] [Securing Code Understanding: Detecting Natural Backdoor Vulnerability in Code Language Models](https://arxiv.org/abs/2606.10846)
...
### [107] [Training LLMs to Enforce Multi-Level Instruction Hierarchies via Gravity-Weighted Direct Preference Optimization](https://arxiv.org/abs/2606.10860)
...
### [108] [Comparative Analysis of Inference-Time Defense Methods for Multimodal Large Language Models](https://arxiv.org/abs/2606.10904)
...
### [109] [Context-Based Adversarial Attacks on AI Code Generators: Vulnerability Analysis and Implications](https://arxiv.org/abs/2606.10945)
...
### [110] [Understanding and mitigating the risks of OpenClaw for non-technical users: A practical guide with Skill](https://arxiv.org/abs/2606.11007)
...
### [111] [When Discovery Outpaces Remediation: Modeling AI-Accelerated Vulnerability Discovery in Interconnected Systems](https://arxiv.org/abs/2606.11022)
...
### [112] [Do Transformers Actually Help Intrusion Detection? A Temporal Sequence Evaluation on CIC-IDS2017](https://arxiv.org/abs/2606.11098)
...
### [113] [A Longitudinal Study of Recently Observed Malicious Domains: Characteristics, Infrastructure, and Abuse Patterns](https://arxiv.org/abs/2606.11111)
...
### [114] [OpenPCC: Open and Confidential LLM Serving on Commodity TEEs](https://arxiv.org/abs/2606.11145)
...
### [115] [Anchors that Don't Lift: Understanding Supply Chain Driven Kernel Lock-In and Governance-Mediated Mitigation Strategies in SOHO Devices](https://arxiv.org/abs/2606.11175)
...
### [116] [EstRTL: Functional Estimation Guided RTL Code Generation](https://arxiv.org/abs/2606.09867)
...
### [117] [Toward a Small ML Runtime Stack for Raspberry Pi 5 QPUs](https://arxiv.org/abs/2606.09905)
...
### [118] [ARTA: Adaptive Reinforcement-Learning-Based Throttling Agent for RowHammer Vulnerabilities](https://arxiv.org/abs/2606.09915)
...
### [119] [SPARX: Secure and Privacy-Aware Approximate CNN Acceleration with Edge RISC-V SoC](https://arxiv.org/abs/2606.09946)
...
### [120] [Toward Intelligent Prefetching: A Survey on Complex Memory Access Prediction Techniques](https://arxiv.org/abs/2606.09955)
...
### [121] [A Generic Modulo-$(2^n\pmδ)$ RNS Multiplier Based on Twit Representation](https://arxiv.org/abs/2606.09965)
...
### [122] [Fault Characterization and Hardening of Combinational Standard Cells Using 3D-TCAD Simulations for Cyber-Physical Systems](https://arxiv.org/abs/2606.10015)
...
### [123] [Isolation-aware Scheduling Framework for DNN-based End-to-End Autonomous Driving System on Tile-based Accelerators](https://arxiv.org/abs/2606.10303)
...
### [124] [A 185 TOPS/W/mm2 Bayesian Inference Engine with 640 aJ Write-Free FeFET GRNG for Uncertainty-Aware Aerial Search and Rescue](https://arxiv.org/abs/2606.10822)
...
### [125] [Arithmetic Packing on Wide Integer Datapaths in DSP Primitives of Modern FPGA Devices](https://arxiv.org/abs/2606.11065)
...
### [126] [Coset Ensemble Decoder for Quantum Error Correction with Algorithm-Hardware Co-Design](https://arxiv.org/abs/2606.11076)
...
### [127] [Towards Autonomous Accelerator Design: FPGA Accelerator Generation with SECDA](https://arxiv.org/abs/2606.11117)
...
### [128] [Defeat the Heap: Zero-Copy Data Movement in AXI4MLIR](https://arxiv.org/abs/2606.11158)
