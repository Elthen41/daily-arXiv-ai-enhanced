...
### [11] [Long-Horizon-Terminal-Bench: Testing the Limits of Agents on Long-Horizon Terminal Tasks with Dense Reward-Based Grading](https://arxiv.org/abs/2607.08964)
...
### [12] [A Formalization of the Mean-Field Derivation of the Vlasov Equation: AI-Assisted Lean Formalization as a Strategy Game](https://arxiv.org/abs/2607.08986)
*Joseph K. Miller*
...
### [13] [ARCANA: A Reflective Multi-Agent Program Synthesis Framework for ARC-AGI-2 Reasoning](https://arxiv.org/abs/2607.09059)
...
### [14] [Neuro-Agentic Control: A Deep Learning-based LLM-Powered Agentic AI Framework for Controlling Security Controls](https://arxiv.org/abs/2607.09076)
...
### [16] [MedRealMM: A Real-World Multimodal Benchmark for Chinese Online Medical Consultation](https://arxiv.org/abs/2607.09142)
...
### [17] [KV-PRM: Efficient Process Reward Modeling via KV-Cache Transfer for Multi-Agent Test-Time Scaling](https://arxiv.org/abs/2607.09153)
...
### [18] [Scoped Verification for Reliable Long-Horizon Agentic Context Evolution under Distribution Shift](https://arxiv.org/abs/2607.09175)
*Dan C. Hsu,Luke Lu*
...
### [19] [Toward Auditable AI Scientists: A Hypothesis Evolution Protocol for LLM Agents](https://arxiv.org/abs/2607.09195)
...
### [20] [OpenProver: Agentic and Interactive Theorem Proving with Lean 4](https://arxiv.org/abs/2607.09217)
...
### [21] [LongMedBench: Benchmarking Medical Agents for Long-Horizon Clinical Decision-Making](https://arxiv.org/abs/2607.09322)
...
### [22] [Communication-Efficient Digital-Twin Coordination for Heterogeneous LLM Embodied Agents over Computing Power Networks](https://arxiv.org/abs/2607.09330)
...
### [23] [Fictional Worldbuilding: Multi-Agent LLM Collaboration with Hierarchical Context Compression and Iterative Review](https://arxiv.org/abs/2607.09403)
...
### [24] [How Does Bayesian Causal Discovery Fail? Characterising Structural Consequences in Linear Gaussian Networks under Latent Confounding](https://arxiv.org/abs/2607.09449)
...
### [25] [ProofCouncil: An LLM Agent for Solving Open Mathematical Problems](https://arxiv.org/abs/2607.09474)
...
### [26] [Ceci n'est pas une pipe: AI systems as semantic abstractions](https://arxiv.org/abs/2607.09489)
...
### [27] [Multimodal Reward Hacking in Reinforcement Learning](https://arxiv.org/abs/2607.09492)
...
### [28] [Shared Selective Persistent Memory for Agentic LLM Systems](https://arxiv.org/abs/2607.09493)
...
### [29] [SAGEAgent: A Self-Evolving Agent for Cost-Aware Modality Acquisition in Multimodal Survival Prediction](https://arxiv.org/abs/2607.09521)
...
### [30] [Beyond Fixed Representations: The Vocabulary and Verifier Gaps in Open-Ended AI](https://arxiv.org/abs/2607.09560)
...
### [31] [Knowledge Graphs and Explainable AI as Complementary Resources for Urban Mining](https://arxiv.org/abs/2607.09578)
...
### [32] [TrustX Agent Risk Classification Framework (ARC): Risk-Tiering Internally Created Agentic AI Systems](https://arxiv.org/abs/2607.09586)
...
### [33] [Agora: Enhancing LLM Agent Reasoning Via Auction-Based Task Allocation](https://arxiv.org/abs/2607.09600)
...
### [35] [A Seed for Privacy -- semi-automatic privacy-revealing data reminder in databases and data streams](https://arxiv.org/abs/2607.08801)
...
### [36] [Privacy-Preserving Intent Fulfilment and Assurance for 6G RAN](https://arxiv.org/abs/2607.08809)
*Joss Armstrong*
...
### [37] [Entropy Bootstrapping for Wireless Embedded Systems](https://arxiv.org/abs/2607.08865)
...
### [38] [Proof-of-Continuity: A Temporal Model for Authority Propagation in Distributed Systems and AI Agents](https://arxiv.org/abs/2607.08906)
*Nicola Gallo*
...
### [39] [SeedSmith: LLM-Driven Seed Synthesis for Directed Fuzzing](https://arxiv.org/abs/2607.08949)
...
### [40] [RaMark: Radioactive Watermarking for Generated Tabular Data](https://arxiv.org/abs/2607.09000)
...
### [41] [Secret Scanner Agent: Extracting Secrets and Access Context from Unstructured Documents](https://arxiv.org/abs/2607.09011)
...
### [42] [SLBench: Evaluating How LLM Agents Follow Logical Relations in Skills](https://arxiv.org/abs/2607.09016)
...
### [43] [SherAgent: Scaling Attack Investigation in the Wild via LLM-Empowered Iterative Query-Filter Backtracking](https://arxiv.org/abs/2607.09176)
...
### [44] [Malaika: Understanding Malware through Tri-Grounded Agentic Reasoning](https://arxiv.org/abs/2607.09179)
...
### [45] [Blockchain-Linked Auditable Decision Management for Telecom/IoT Fraud-Control Requests](https://arxiv.org/abs/2607.09259)
...
### [46] [Leveraging Interpretable Tsetlin Machine for PDF Malware Detection](https://arxiv.org/abs/2607.09290)
*Rahul Jaiswal*
...
### [47] [SFDS: Selective File Disclosure System](https://arxiv.org/abs/2607.09370)
...
### [48] [Federated Learning Architecture: Data Privacy and System Security Approaches](https://arxiv.org/abs/2607.09391)
...
### [49] [Triggering Stealthy Feature Map Backdoors via Physical Fault Injection in Embedded Neural Networks](https://arxiv.org/abs/2607.09473)
...
### [50] [Portable Acceleration of Learning With Errors KEMs for Post-Quantum Cryptography](https://arxiv.org/abs/2607.09541)
...
### [51] [VEXAIoT: Autonomous IoT Vulnerability EXploitation using AI Agents](https://arxiv.org/abs/2607.09653)
...
### [52] [Impact of Benign Connectivity Variations on Intrusion Detection for Encrypted OPC UA Traffic in Industrial Private 5G Networks](https://arxiv.org/abs/2607.09659)
...
### [53] [StreamDQ: Near-Memory Weight DeQuantization in Custom HBM for Scalable AI Inference Acceleration](https://arxiv.org/abs/2607.08993)
