...
### [1] [Hot AI in Cold Space: Thermal-Crosstalk-Aware Scheduling for Sustainable Orbital AI Clusters](https://arxiv.org/abs/2606.26150)
...
### [2] [FinWhale: An Optimally Resilient Two-Round Terminating DAG Protocol](https://arxiv.org/abs/2606.26292)
...
### [3] [A Distributed Quantum Approximate Optimization Algorithm Simulator for Engineering Design Optimization](https://arxiv.org/abs/2606.26297)
...
### [4] [Priceless: An examination of Serverless Functions-as-a-Service (FaaS) pricing models](https://arxiv.org/abs/2606.26308)
*Nnamdi Ekwe-Ekwe*
...
### [5] [Moebius: Serving Mixture-of-Expert Models with Seamless Runtime Parallelism Switch](https://arxiv.org/abs/2606.26607)
...
### [6] [Simulating Unified Tensor Resharding in heterogeneous AI systems](https://arxiv.org/abs/2606.26633)
...
### [7] [RolloutPipe: Overlapping Pipelined Rollout and Training in Disaggregated On-Policy LLM Reinforcement Learning](https://arxiv.org/abs/2606.26997)
...
### [8] [DMuon: Efficient Distributed Muon Training with Near-Adam Overhead](https://arxiv.org/abs/2606.27153)
...
### [9] [CHAMB-GA: A Containerized HPC Scalable Microservice-Based Framework for Genetic Algorithms](https://arxiv.org/abs/2606.27217)
...
### [10] [MIRAGE: Protecting against Malicious Image Editing via False Moderation](https://arxiv.org/abs/2606.26199)
...
### [11] [Data Facts: A Metadata Schema for Structured Data Exchange in the NANDini Multi-Agent Ecosystem](https://arxiv.org/abs/2606.26211)
...
### [12] [CyberChainBench: Can AI Agents Secure Smart Contracts Against Real-World On-Chain Vulnerabilities?](https://arxiv.org/abs/2606.26216)
...
### [13] [Expecting (Targeted Ads)? Network Analysis of User Health Data Leakage in Fertility Tracking Apps](https://arxiv.org/abs/2606.26276)
...
### [14] [TEMPO-Diffusion: Temporally Exposed Malicious Poisoning of Diffusion Models](https://arxiv.org/abs/2606.26285)
...
### [15] [Beyond Takedown: Measuring Malicious Go Module Persistence in the Wild](https://arxiv.org/abs/2606.26291)
...
### [16] [Hybrid privacy-aware semantic search: SVD-truncated document geometry and CKKS-encrypted query reranking under a restricted threat model](https://arxiv.org/abs/2606.26373)
*Sergey Kurilenko*
...
### [17] [Verifying Intent and Harm: A Unified Defense Against LLM-Generated Threats](https://arxiv.org/abs/2606.26377)
...
### [18] [Lessons from the Adoption and Deprecation of the Privacy Sandbox Web APIs](https://arxiv.org/abs/2606.26390)
...
### [19] [What Browsers Do in the Shaders: A Measurement Study of WebGPU Privacy](https://arxiv.org/abs/2606.26412)
*Igor Santos-Grueiro*
...
### [20] [Adaptive Evaluation of Out-of-Band Defenses Against Prompt Injection in LLM Agents](https://arxiv.org/abs/2606.26479)
...
### [21] [DKVE: Decentralized Key Validation for End-to-End Encrypted Messaging](https://arxiv.org/abs/2606.26486)
...
### [22] [VIGIL: Runtime Enforcement of Behavioral Specifications in AI Agent Skills](https://arxiv.org/abs/2606.26524)
...
### [23] [TESLA-for-5G: Broadcast Authentication for 5G Networks Using TESLA](https://arxiv.org/abs/2606.26528)
...
### [24] [Tilikum: Transaction Fair Ordering on a DAG without Weak Edges](https://arxiv.org/abs/2606.27250)
...
### [27] [TGHE: Template-based Graph Homomorphic Encryption for Privacy-Preserving GNN Inference in Edge-Cloud Systems](https://arxiv.org/abs/2606.26664)
...
### [28] [The Fungible Reserve Standard: A Deterministic Framework for Encoding Carrying Costs in Asset-Backed Tokens](https://arxiv.org/abs/2606.26704)
...
### [29] [DroidBreaker: Practical and Functional Problem-Space Attacks on Machine-Learning Android Malware Detectors](https://arxiv.org/abs/2606.26707)
...
### [30] [MergeLLL: A Hierarchical Divide-and-Conquer Framework for LLL-Based Lattice Reduction](https://arxiv.org/abs/2606.26784)
*Niharika Gauraha*
...
### [31] [MIRROR: Novelty-Constrained Memory-Guided MCTS Red-Teaming for Agentic RAG](https://arxiv.org/abs/2606.26793)
...
### [32] [SpikeTimer: Exploring Active Copyright Protection in Spiking Neural Networks via Temporal Backdoor Regularization](https://arxiv.org/abs/2606.26841)
...
### [33] [Fortress and Gatekeeper: Theorizing Transitive Trust in Third-Party Cybersecurity Risk Governance](https://arxiv.org/abs/2606.26866)
...
### [34] [Chai: Agentic Discovery of Cryptographic Misuse Vulnerabilities](https://arxiv.org/abs/2606.26933)
...
### [35] [Jailbreaking for the Average Jane: Choosing Optimal Jailbreaks via Bandit Algorithms for Automatically Enhanced Queries](https://arxiv.org/abs/2606.26936)
...
### [36] [Protocol Prying: Systematic Vulnerability Research in the Apple AirDrop and Android Quick Share Proximity Transfer Protocols](https://arxiv.org/abs/2606.26967)
...
### [37] [ShareLock: A Stealthy Multi-Tool Threshold Poisoning Attack Against MCP](https://arxiv.org/abs/2606.27027)
...
### [38] [Design and Performance Evaluation of Secure RF and WiFi-Based Communication in Drone Swarms via Testbed Implementation](https://arxiv.org/abs/2606.27028)
...
### [39] [Physical Layer Authentication With Channel Knowledge Maps in Indoor Environments](https://arxiv.org/abs/2606.27044)
...
### [40] [Type-based information flow analysis for $π$-calculus with a dynamically extensible security lattice](https://arxiv.org/abs/2606.27059)
...
### [41] [Inherited Circuits, Learned Semantics: How Fine-Tuning Creates Evasion Vulnerabilities Invisible to Standard Evaluation](https://arxiv.org/abs/2606.27091)
*Ryan Fetterman*
...
### [42] [zQR: A Verifiable QR-Driven zkSNARK Proof Verification Framework for Mobile Platforms](https://arxiv.org/abs/2606.27092)
...
### [43] [Application of LLMs to Threat Assessment of Foreign Peacekeeping Missions](https://arxiv.org/abs/2606.27106)
...
### [44] [PRISM: PE Relational Inter-Section Matrix. A 2D Section-Aware Dataset for Static PE Malware Detection](https://arxiv.org/abs/2606.27109)
...
### [45] [The Observer World: A Cryptographic Extension of Impagliazzo's Five Worlds](https://arxiv.org/abs/2606.27139)
*Fabio F. G. Buono*
...
### [46] [Mitigating High-Frequency Geometric Noise in Non-Parametric 1-Bit Sparse](https://arxiv.org/abs/2606.26137)
*Lars Kopp*
...
### [47] [The Kernel's Write: Application Read-Only Memory](https://arxiv.org/abs/2606.26138)
...
### [48] [Toward Mitigating Process-Induced Performance Degradation in 3.5D Heterogeneous Packages via Pre-Silicon Firmware Co-Optimization](https://arxiv.org/abs/2606.26176)
...
### [49] [CVA6-RT: an Open-Source Time-Predictable RV64 Processor for Mixed-Criticality Systems](https://arxiv.org/abs/2606.26177)
...
### [50] [Nanoelectromechanical Systems (NEMS) for Hardware Security in Advanced Packaging](https://arxiv.org/abs/2606.26426)
...
### [51] [GRAINS: Storage-Aware Algorithm-Architecture Co-Design Enabling High-Performance and Low-Cost Graph-Based Genome Analysis](https://arxiv.org/abs/2606.26468)
...
### [52] [SegFold: Accelerating Sparse GEMM with a Fine-Grained Dynamic Dataflow](https://arxiv.org/abs/2606.26701)
...
### [53] [Residual GPU Cache State on Apple M4 Pro](https://arxiv.org/abs/2606.27098)
...
### [54] [Evaluating Architectural Trade-offs in CGRAs: The Impact of Scratchpad Memory and Heterogeneity on Compute-Intensive Kernels](https://arxiv.org/abs/2606.27240)
...
### [55] [CHIA: An open-source framework for principled, agentic AI-driven hardware/software co-design research](https://arxiv.org/abs/2606.27350)
