...
### [1] [When Does Learning Beat Heuristics? A Case Study in Kubernetes Scheduler Score Plugins](https://arxiv.org/abs/2609.22142)
...
### [2] [The Tethys Dataset: Seven Years of Hourly Smart Water Metering and a Pipeline for Making It Usable](https://arxiv.org/abs/2609.22358)
...
### [3] [Trust-Aware Output Management for Physical Neural Network in Cloud-Continuum Systems](https://arxiv.org/abs/2609.22443)
...
### [4] [Mask-Aware Execution for Efficient JEPA Training](https://arxiv.org/abs/2609.22674)
...
### [5] [Replacing Large Language Models with Jev Decision Models for Low-Latency Edge Service Orchestration](https://arxiv.org/abs/2609.22753)
...
### [6] [NSP: Accelerating Variable-Length LLM Training via Nested Sequence Parallelism](https://arxiv.org/abs/2609.22755)
...
### [7] [From Idle to Urgent: A Resource-Harvested HPC Workflow for High-Fidelity Seismic Estimation](https://arxiv.org/abs/2609.22814)
...
### [8] [DeepSeek Elastic Compute (DSec): A Sandbox Infrastructure for Effective Agentic Training at Scale](https://arxiv.org/abs/2609.22978)
...
### [9] [Silent Failures at the $2^{32}$ Boundary: A Technical Report on Large-Tensor Matrix Multiplication in PyTorch's Apple MPS Backend](https://arxiv.org/abs/2609.22991)
*Junichiro Niimi*
...
### [10] [Accurate Simulation of Distributed Training Jobs with Network Contention Modeling](https://arxiv.org/abs/2609.23278)
...
### [11] [Accurate Distributed Tracing for Large-Scale AI Infrastructure: Time Synchronization as a Foundation for Reliable Observability](https://arxiv.org/abs/2609.23301)
...
### [12] [Co-occurrence Patterns of LoRA Adapters in Production Diffusion Model Inference Services](https://arxiv.org/abs/2609.23321)
...
### [13] [Economical and efficient big data sharing with i-Cloud](https://arxiv.org/abs/2609.23438)
...
### [14] [Conflicting Pattern Formation by Teams of Anonymous, Fully Disoriented Robots](https://arxiv.org/abs/2609.23454)
...
### [15] [Explicit State and Resource Contracts for Low-Precision Pipeline Parallel Training under Captured Graphs](https://arxiv.org/abs/2609.23536)
...
### [16] [SAGE: Optimal-Stopping Peer Selection for Decentralised Federated Learning](https://arxiv.org/abs/2609.23773)
...
### [17] [Byzantine Causal Reliable Broadcast (BCRB) with Constant-Size Message Metadata](https://arxiv.org/abs/2609.24018)
...
### [18] [MCP-GRANITE Benchmark: GRANularity Interface TEsting for MCP-Based LLM Agents](https://arxiv.org/abs/2609.24161)
...
### [19] [A principled approach for energy-efficient training via phase-aware GPU frequency tuning](https://arxiv.org/abs/2609.24205)
...
### [20] [Toward GPU-Resident Climate Models: A Feasibility Study on Lossy Compression for the Spherical Harmonic Transform's Communication Bottleneck](https://arxiv.org/abs/2609.24294)
...
### [21] [Conduit: An Experience Data Plane for Distributed Reinforcement Learning](https://arxiv.org/abs/2609.24456)
...
### [22] [Bridging the Vendor Gap: Enabling AMD GPU Support for Awkward Array via ROCm/HIP for the HL-LHC Era](https://arxiv.org/abs/2609.24628)
...
### [23] [Analytical Power-Aware Provisioning for Prefill-Decode Disaggregated AI Inference](https://arxiv.org/abs/2609.24639)
...
### [24] [Mitigating Front-Running Attacks through Fair and Resilient Transaction Dissemination](https://arxiv.org/abs/2609.24713)
...
### [25] [Tiga: Compiling Graph Message Passing at Scale](https://arxiv.org/abs/2609.24802)
*Mingyuan Chi*
...
### [26] [Who Pays for the KV Cache? Attributing Shared AI Inference Spend Across Kubernetes and LLM Provider Bills](https://arxiv.org/abs/2609.24991)
*Timothy Urista*
...
### [27] [KerColle: Unlocking Fine-Grained GPU Concurrency in Vision-Language-Action Models](https://arxiv.org/abs/2609.22335)
...
### [28] [Design-Space Exploration of Post-Quantum Cryptography Acceleration on an Open-Source RISC-V GPGPU](https://arxiv.org/abs/2609.22343)
...
### [29] [Verification Reward Model for Reinforcement Learning in Chip Design Verification](https://arxiv.org/abs/2609.22347)
*Shashank Chaurasia*
...
### [30] [UniCASE: A Unified 16-bit Floating-Point Format with Criticality-Aware Selective ECC for Efficient DNN Protection](https://arxiv.org/abs/2609.22590)
...
### [31] [Presage: Prefetch Search via Agent-Guided Experiments](https://arxiv.org/abs/2609.22636)
...
### [32] [TEMPO: A Tag-Based Framework for Efficient Memory Ordering](https://arxiv.org/abs/2609.22743)
...
### [33] [Quality over Quantity: Diversity-Aware Data Selection for Efficient Verilog Code Generation](https://arxiv.org/abs/2609.22765)
...
### [34] [Benchmarking StreamNTT with a Verilog-to-Routing Toolchain](https://arxiv.org/abs/2609.23116)
...
### [35] [WaveletECO: A Closed-Loop Physical ECO Platform and a Specialized Local Language Model](https://arxiv.org/abs/2609.23444)
...
### [36] [SPLASH: Co-Designing Sparse Attention with High-Bandwidth Flash for Efficient Long-Context Inference](https://arxiv.org/abs/2609.23816)
...
### [37] [Dissecting How Die Scaling Breaks GPU Fine-grained Scheduling](https://arxiv.org/abs/2609.24270)
...
### [38] [Circuit-Architecture-Training Co-Design with Regenerative-SA Similarity Sensing for Aggressive SAR Skipping in Analog Compute-in-Memory](https://arxiv.org/abs/2609.24288)
...
### [39] [NPU Accelerator: Quantized Real-Time Vehicle Detection on PYNQ-Z1 Using FINN](https://arxiv.org/abs/2609.24757)
...
### [40] [SPECTRA: Adaptive Execution of Speculative Decoding on a Runtime-Reconfigurable Tiled Architecture](https://arxiv.org/abs/2609.24847)
...
### [41] [Toward Multi-kW Power Delivery Methodologies for Advanced 3D Heterogeneous Integration](https://arxiv.org/abs/2609.24904)
...
### [42] [Differentially Private and Fairness-Audited Score Diffusion for Irregular Longitudinal Health Records](https://arxiv.org/abs/2609.22401)
*Taimoor Ahmad*
...
### [43] [Defusing Explosive Prompts: Understanding and Preventing Trigger-Based Prompt Injections in LLM Agents](https://arxiv.org/abs/2609.22510)
...
### [44] [Tick-Tock on the Open Fronthaul: Securing Synchronization in O-RAN](https://arxiv.org/abs/2609.22525)
...
### [45] [Zero-Trust Authorization and Discovery for Enterprise MCP](https://arxiv.org/abs/2609.22573)
...
### [46] [From Capability to Assurance in Autonomous Penetration-Testing Harnesses: A Framework and Reference Implementation](https://arxiv.org/abs/2609.22664)
...
### [47] [UBA-ORL: Unlearning-Activated Backdoor Attacks on Offline Reinforcement Learning](https://arxiv.org/abs/2609.22711)
...
### [48] [MATE: Policy-Aware Security Auditing for Mobile Agents via Synthesis-Driven Trajectory Learning](https://arxiv.org/abs/2609.22724)
...
### [49] [SelfOp: An Optimization Algorithm for Self-Improving Security Agents](https://arxiv.org/abs/2609.22792)
...
### [50] [The Price of Safety: Benign-Case Utility and Token Overhead of Memory-Poisoning Defenses in LLM Agents](https://arxiv.org/abs/2609.22818)
*Pritom Bhowmik*
...
### [51] [When Label Noise Meets Class Imbalance: A Robust Framework for Android Malware Family Classification](https://arxiv.org/abs/2609.22835)
...
### [52] [SMS-delivered network-initiated SUPL on Pixel 8: a privacy assessment](https://arxiv.org/abs/2609.22900)
*Douglas Leith*
...
### [53] [Beyond Single-Model Injection: A Threat Model and Defense Architecture for Prompt Injection in Multi-Agent Systems](https://arxiv.org/abs/2609.22949)
...
### [54] [When Agentic Trust Crosses Organizational Boundaries: Structural Externalization and a Reference Model for Trust Evidence](https://arxiv.org/abs/2609.22961)
*Huafu Li,Jia Xia*
...
### [55] [Dual-Locking Learned AI Models: A PIN-Based Sparse QIM Watermarking and Adaptive Index Permutation Approach](https://arxiv.org/abs/2609.22981)
...
### [56] [Secrets That Survive Everything: Runtime Credential Exposure in Production Web Applications](https://arxiv.org/abs/2609.23042)
*Hemanth Gorijala*
...
### [57] [An LLM-Assisted AutoML Framework for Intrusion Detection in IoT Networks](https://arxiv.org/abs/2609.23097)
*Li Yang*
...
### [58] [Exploiting Software-level Abstractions To Support Practical Hardware Trojan Attacks](https://arxiv.org/abs/2609.23173)
...
### [59] [Assessing Runtime Electromagnetic Detection of CPU Hardware Trojans Targeting Kernel Memory](https://arxiv.org/abs/2609.23186)
...
### [60] [LLMs as Linguistic Chameleons: Decoupling Semantics and Structure for Privacy-Preserving Communication](https://arxiv.org/abs/2609.23193)
...
### [61] [SoK: From Finding to Deployment: Systematizing the OS Kernel Bug Lifecycle](https://arxiv.org/abs/2609.23218)
...
### [62] [Security of Agent-Integrated Software: When Human Operations and Agent Actions Coexist](https://arxiv.org/abs/2609.23226)
...
### [63] [CLOADER: Evading Security Mobile Defenses via Runtime Obfuscation and Adaptive Hooking Tactics](https://arxiv.org/abs/2609.23396)
...
### [64] [The Anatomy of Address Poisoning on Ethereum: Funding Mechanisms, Scam Signatures, and Laundering via Tornado Cash](https://arxiv.org/abs/2609.23405)
...
### [65] [Runtime Authorization Consistency Checking for MCP-based Agentic Workflows](https://arxiv.org/abs/2609.23498)
...
### [66] [Endogenous Interpretation](https://arxiv.org/abs/2609.23514)
*Antonio Nappa*
...
### [67] [POZZER: A Power Side Channel-guided Fuzzer for Black-Box Embedded Systems](https://arxiv.org/abs/2609.23583)
...
### [68] [When the Agent Becomes the Kernel: A Systematization of Security on the Path to AI-Native Operating Systems](https://arxiv.org/abs/2609.23700)
...
### [69] [TriFleetRCA: On-Premise LLM Root Cause Analysis for Kubernetes](https://arxiv.org/abs/2609.23766)
...
### [70] [Pattern-level Differential Privacy for High-utility Complex Event Processing](https://arxiv.org/abs/2609.23827)
...
### [71] [SyzHarness: Patch-Based Kernel Bug Reproduction with LLM-Synthesized Fuzzing Harnesses](https://arxiv.org/abs/2609.23889)
...
### [72] [Connecting the Dots in Agentic AI Security: A Cross-Dimensional Threat Taxonomy, Evaluation Maturity, and Open Challenges](https://arxiv.org/abs/2609.23894)
...
### [73] [Benchmarking Post-Quantum Cryptography in Lightweight Virtualization Environments on Embedded Hardware](https://arxiv.org/abs/2609.23902)
...
### [74] [SkelOT: Reusing AOT Compilation Across EVM Contract Families](https://arxiv.org/abs/2609.24404)
...
### [75] [MobileCybench: Evaluating Agent Vulnerability Discovery via Executable Probes](https://arxiv.org/abs/2609.23980)
...
### [76] [LeaseGuard: Incumbent-Preserving Admission Control for Privileged LLM Agents](https://arxiv.org/abs/2609.24077)
...
### [77] [From Bits to Beliefs: Recoverable Semantic Fingerprints for Black-Box Verification of Large Language Models](https://arxiv.org/abs/2609.24084)
...
### [78] [Monet: Measuring the Ecosystem of Open-Source Text-to-Image Models Tailored for Harmful Services](https://arxiv.org/abs/2609.24134)
...
### [79] [KEVGraph: Exploitation-Aware Dependency Vulnerability Remediation](https://arxiv.org/abs/2609.24164)
*Daniel Okumu Omondi*
...
### [80] [Forgeable Confirmation in Automated Computer Security Testing: Deterministic Rules versus AI Judges](https://arxiv.org/abs/2609.24200)
...
### [81] [Temporal Generalization and Explanation Stability of Control Flow Graph Neural Networks for Malware Detection](https://arxiv.org/abs/2609.24280)
...
### [82] [rApp/xApp Attestation: A New Security Use Case for O-RAN](https://arxiv.org/abs/2609.24296)
...
### [83] [Name2Pkg: Lightweight One-Class Android Malware Screening via Name-Package Correspondence Modeling](https://arxiv.org/abs/2609.24389)
...
### [84] [Passive Hybrid Network-Based Intrusion Detection System (Hybrid-NIDS) Combining Suricata and Random Forest](https://arxiv.org/abs/2609.24393)
...
### [85] [ActGov: Governing LLM Agent Actions via Policy-Constrained Validation](https://arxiv.org/abs/2609.24446)
...
### [86] [Prefix Puncturable Signatures with Smaller Signing Key from HIBS](https://arxiv.org/abs/2609.24503)
...
### [87] [Beyond Predictable Paths: Redefining AI Security Incident Reporting for Agents](https://arxiv.org/abs/2609.24515)
...
### [88] [State-Aware Fuzzing of JavaScript Engines with LLM-Guided Instrumentation](https://arxiv.org/abs/2609.24550)
...
### [89] [5G-Shark: A Network Security Auditor for 5G Subscriber Privacy and Unauthenticated Signalling Resilience](https://arxiv.org/abs/2609.24656)
...
### [90] [Trust in Edge-Enabled IoT Security: Features, Challenges and Research Directions](https://arxiv.org/abs/2609.24669)
...
### [91] [Domain Specific Post Quantum Signatures for Blockchains](https://arxiv.org/abs/2609.24689)
*Maja Lie,Ben Marsh*
...
### [92] [Reasoning Topology Matters: A Controlled Study of LLM-Based Cybersecurity Analysis](https://arxiv.org/abs/2609.24710)
...
### [93] [Decoding Guardrails: XAI-Guided Perturbation Analysis of Prompt Injection Detection](https://arxiv.org/abs/2609.24801)
...
### [94] [OPBackdoor: Opportunistic Backdoors via Alibi-Aligned Reasoning](https://arxiv.org/abs/2609.24826)
...
### [95] [Residual Community Prototypes Under-Reject Held-Out Malware Families in FCG-MFD](https://arxiv.org/abs/2609.24980)
*Junru Zhu,Yixin Yang,Xiaoqing Ding,Ruoyu Qi*
...
### [96] [Didactic knowledge or Clinical Cases? How Data Types Shape Medical Large Language Models](https://arxiv.org/abs/2609.22161)
...
### [97] [An Affordable AI-Integrated Smart Cane for Multimodal Mobility Assistance of Visually Impaired Users](https://arxiv.org/abs/2609.22277)
...
### [98] [PAANI : On Device Visual Evidence Fusion and Explainable Guidance for River Robot Simulation](https://arxiv.org/abs/2609.22353)
...
### [99] [Social Influence and the Allocation of Scientific Attention in AI Populations](https://arxiv.org/abs/2609.22408)
*Maxim Chupilkin*
...
### [100] [Learning 3D biophysical cell properties from 2D images and cell-population statistics](https://arxiv.org/abs/2609.22410)
...
### [101] [Goal-driven Variant Categorization](https://arxiv.org/abs/2609.22475)
...
### [102] [Replication Without Persistence in Hosted LLMs: Measurement Sensitivity in Action-Time Belief Evaluation](https://arxiv.org/abs/2609.22478)
...
### [103] [The Wisdom of Artificial Deliberative Crowds](https://arxiv.org/abs/2609.22497)
...
### [104] [Agreement Overstates Evidence: Error Dependence in LLM Judge Consensus](https://arxiv.org/abs/2609.22512)
...
### [105] [IntLawNER: A Named Entity Recognition Dataset and Benchmark in International Law](https://arxiv.org/abs/2609.22529)
...
### [106] [EvidenT: Building Trustworthy Enterprise Assistants through Evidence Groundedness and Traceability](https://arxiv.org/abs/2609.22537)
...
### [107] [AutoGym: Blueprint-First Generation of Verifiable Agent Gyms](https://arxiv.org/abs/2609.22592)
...
### [108] [MAWILE: Multi-Axis Workbench for Inspecting LLM Evaluators](https://arxiv.org/abs/2609.22599)
...
### [109] [GaitVista: Reliability-Aware AI Measurement toward Accessible Longitudinal Gait Assessment](https://arxiv.org/abs/2609.22619)
...
### [110] [Splitting Documents at Lower Cost: Multi-Split Boundary Decisions for LLM-Based Page Stream Segmentation](https://arxiv.org/abs/2609.22620)
...
### [111] [Text, Pixels, or Both? Evaluating Input Representations for Multimodal Document QA](https://arxiv.org/abs/2609.22628)
*Nikhil Reddy Pottanigari,Sepideh Kharaghani,Saverio Vadacchino,Alejandro Posada,Ying Zhang*
...
### [112] [DVA-Neurons: Design and Verification of Adaptive LIF Neurons: From Single-Neuron Dynamics to Multi-Neuron Spiking Networks](https://arxiv.org/abs/2609.22775)
...
### [113] [Self-Organizing Agent Teams Learn to Reason Together](https://arxiv.org/abs/2609.22682)
...
### [114] [Generative Embodied Multiple Behavior Control Systems for Human-like Agents](https://arxiv.org/abs/2609.22691)
...
### [115] [Toward Auditable and Calibrated AI for Dementia-Related Crash Severity Prediction: A Selective Deferral Framework to Support Human Review](https://arxiv.org/abs/2609.22694)
...
### [116] [A Survey on the Linear Representation Hypothesis](https://arxiv.org/abs/2609.22695)
...
### [117] [Building Trustworthy Mental Health Benchmarks on Bluesky: A Validation-Aware Weak-Supervision Framework](https://arxiv.org/abs/2609.22696)
...
### [118] [Hapi: A Multivariable Land-Surface Transformer for Medium-Range Hydrological Forecasting at Continental Scale](https://arxiv.org/abs/2609.22702)
...
### [119] [Trustworthy Agentic AI: Failure Modes, Mitigation Strategies, and a Lifecycle Framework for Autonomous LLM Systems](https://arxiv.org/abs/2609.22712)
...
### [120] [ProcessLight: Process Supervision for Large Language Model Based Traffic Signal Control](https://arxiv.org/abs/2609.22746)
...
### [121] [CTSpinoPelvic1K: spine, pelvis, ribs and femora in one coordinate frame, annotated for lumbosacral transitional anatomy](https://arxiv.org/abs/2609.22760)
...
### [122] [From Research Frontier to Laboratory Bench: Design of a Four-Tier Experimental Teaching System for Multimodal Medical Image Intelligent Diagnosis](https://arxiv.org/abs/2609.22790)
...
### [123] [ISA-Bench: A Benchmark for Computational Reasoning Across Instruction Set Architectures](https://arxiv.org/abs/2609.22878)
...
### [124] [When Should a VLM Look? Paying Only for Visual Calls That Were Needed and Used](https://arxiv.org/abs/2609.22910)
...
### [125] [Beyond Linear Context: Graph-Guided Evidence Navigation for Long-Novel Reasoning with a Local 9B Language Model](https://arxiv.org/abs/2609.22939)
*Wenji Fu*
...
### [126] [AgentRouter: Heterogeneous Model Routing for Cost-Optimal Multi-Step Agentic Workflows](https://arxiv.org/abs/2609.22951)
*Rudrendu Kumar Paul,Sourav Nandy*
...
### [127] [A Compact Stance-Indexed Anterior-Posterior COP Representation for Parkinson's Disease Classification from Plantar VGRF](https://arxiv.org/abs/2609.22956)
...
### [128] [R-GEAN: Regimen-Guided Edit Action Network for Within-Admission Medication Change Prediction](https://arxiv.org/abs/2609.22959)
...
### [129] [OptiSkill: A Hierarchical and Evolving SkillBank for LLM-Based Optimization Modeling](https://arxiv.org/abs/2609.22987)
...
### [130] [PINNForge: Execution-Grounded Evolutionary Design of Physics-Informed Neural Networks for PDE Solving via Large Language Models](https://arxiv.org/abs/2609.23023)
...
### [131] [Spatial-Interactor: Learning Spatial Reasoning through Interaction with the Observable Physical World](https://arxiv.org/abs/2609.23038)
...
### [132] [Enforcing Narrative Reliability and Epistemic Pacing in LLM-Driven Detective Games via Structured Knowledge Trees](https://arxiv.org/abs/2609.23043)
...
### [133] [LazyAgent: Demand-Driven Materialization and Physical Optimization of Agentic Programs](https://arxiv.org/abs/2609.23058)
*Xin Heng*
...
### [134] [FireWorldBench: Benchmarking Complex Physical World Intelligence through Coupled-Field Fire Dynamics](https://arxiv.org/abs/2609.23064)
...
### [135] [Tutoring Large Language Models to be Domain-adaptive, Precise and Safe](https://arxiv.org/abs/2609.23071)
*Somnath Banerjee*
...
### [136] [Event Signature Transfer: Model-Agnostic Forecast Scenario Construction from Historical Events](https://arxiv.org/abs/2609.23074)
...
### [137] [From Inference Engine to Inference Control Plane: Connecting vLLM, llm-d, and the Evolution of Efficient Distributed LLM Serving](https://arxiv.org/abs/2609.23130)
*Twinkll Sisodia*
...
### [138] [CraftBench-UE: Deterministic Evaluation for Coding Agents in Unreal Engine](https://arxiv.org/abs/2609.23142)
...
### [139] [Do Not Trust the Benchmark: Limitations of General LLM Rankings and a Case for Task-Specific Evaluation](https://arxiv.org/abs/2609.23201)
*Danial Amin*
...
### [140] [Expansion Counts under Standard A* Tie-Breaking Strategies on the Final Plateau](https://arxiv.org/abs/2609.23293)
*Alex Fukunaga*
...
### [141] [TicTacBench: Benchmarking Timing Closure Capabilities of Coding Agents](https://arxiv.org/abs/2609.23363)
...
### [142] [Leaky-integrator reconstruction: taming error accumulation in recursive differenced time-series forecasting](https://arxiv.org/abs/2609.23378)
*Zijiang Yang*
...
### [143] [AgentBetta: Verification-Driven Adaptive Configuration of an AI Nano-Agent through Selective Expansion and Verified Contraction](https://arxiv.org/abs/2609.23512)
*Md. Ashraful Babu*
...
### [144] [Are Human-Aligned Models Models of Humans? A Turing-Test Gap in Preference Alignment](https://arxiv.org/abs/2609.23640)
...
### [145] [PhysAI-Bench: A Benchmark for LLM-Based Agentic Decision-Making in Autonomous UAV-Centric Physical AI](https://arxiv.org/abs/2609.23695)
...
### [146] [ScholarStack: Layered Research Asset Orchestration and Cross-Task Reuse for Scientific Agents](https://arxiv.org/abs/2609.23735)
...
### [147] [On Probabilistic Inference Through Parametric Tensor Decomposition in Base Tensor Networks](https://arxiv.org/abs/2609.23774)
...
### [148] [Agents That Edit Documents: Measuring Agentic PDF Forgery Against a Non-Agentic Control](https://arxiv.org/abs/2609.23953)
...
### [149] [Total Cost of Agency: Exact Attribution of Memory Injection Cost in Multi-Agent LLM Workflows](https://arxiv.org/abs/2609.23790)
...
### [150] [Structured Decomposition for Reliable LLM-Generated Access Control Policies](https://arxiv.org/abs/2609.24036)
...
### [151] [WorkWorlds: An Infrastructure for Evaluating AI Agents on Workplace Tasks](https://arxiv.org/abs/2609.23806)
...
### [152] [Pretraining of Medical Visual Encoders Toward Multi-modal Large Language Models](https://arxiv.org/abs/2609.23860)
*Tianyou Jiang*
...
### [153] [Explainable Recommendations at Scale: LLM Rationales for YouTube Music Artist Discovery](https://arxiv.org/abs/2609.23877)
...
### [154] [Increasing Skill Level Recruits Deeper Attention Layers in a Frozen Chess Transformer](https://arxiv.org/abs/2609.23917)
*David Litman*
...
### [155] [Echo State Network (ESN) for Signal Recovery in RF-Impaired IBFD MIMO Systems](https://arxiv.org/abs/2609.23945)
...
### [156] [Divergent strategies and convergent outcomes in autonomous materials discovery](https://arxiv.org/abs/2609.23957)
*Jihan Kim*
...
### [157] [UniK: Universal Knowledge Perception for Digital and Physical AI](https://arxiv.org/abs/2609.23971)
...
### [158] [LEAP-NBV: Lightweight Edge Active-Perception for Foundation-Model Next-Best-View Planning](https://arxiv.org/abs/2609.23974)
...
### [159] [Jev-Mem: System-One-Controlled Agentic Memory for Efficient AI Agents](https://arxiv.org/abs/2609.23986)
...
### [160] [ACLArena: Agent Continue Learning in Multi-stage Post-training](https://arxiv.org/abs/2609.23989)
...
### [161] [FinInteract: Benchmarking Clarification and Intent Integration in Ambiguous Financial Question Answering](https://arxiv.org/abs/2609.24002)
...
### [162] [Testing, not presuming, adequacy: calibrating generative social simulators against emergent network structure](https://arxiv.org/abs/2609.24012)
...
### [163] [Context-Aware Pre-Deployment Evaluation of AI Systems: A Regulatory Framework for Nigerian Fintech](https://arxiv.org/abs/2609.24016)
...
### [164] [Synthesizing Reactive Character Behaviors for Continuous Games via Programmatic Policy Search](https://arxiv.org/abs/2609.24025)
...
### [165] [Representation-guided in-context learning for medical image interpretation with multimodal large language models](https://arxiv.org/abs/2609.24057)
...
### [166] [Incremental Consistency Execution for Autonomous Intelligent Systems](https://arxiv.org/abs/2609.24090)
...
### [167] [DocMIDE: Learning Multi-Hop Implicit Derivation in Visually Rich Documents](https://arxiv.org/abs/2609.24092)
...
### [168] [When More Evidence Hurts: Publication-Bias Drift and Principled Stopping for Biomedical Causal Search](https://arxiv.org/abs/2609.24101)
...
### [169] [EDGEGEN: Improving Tool-Calling Agents Beyond Happy Paths with Synthetic Edge Case Generation](https://arxiv.org/abs/2609.24115)
...
### [170] [Self-Healing Harness for Runtime Oversight of Agent Self-Modification](https://arxiv.org/abs/2609.24130)
...
### [171] [APEXA: Execution-Integrity Enforcement for Multi-Agent LLM Automation of Synchrotron Data Reduction](https://arxiv.org/abs/2609.24165)
...
### [172] [CREDO: Variance-Guided Rubric Evolution for Replay-Corrected Credit Assignment](https://arxiv.org/abs/2609.24174)
*Xuchun Hu*
...
### [173] [LIMIT: Less Is More for Instruction Tuning in Text-to-SQL](https://arxiv.org/abs/2609.24186)
...
### [174] [SKstars at SHROOM: Visions Agreement-Guided Ensembling of Zero-Shot and LoRA-Adapted Vision--Language Models](https://arxiv.org/abs/2609.24198)
...
### [175] [Recovering Lost Details: Multi-Scale Frequency Compensation for Long-Term Time Series Forecasting](https://arxiv.org/abs/2609.24229)
...
### [176] [Taming CoT Obfuscation in VLMs: From Mechanistic Evidence to Activation Enforcement](https://arxiv.org/abs/2609.24243)
...
### [177] [Unsupervised Brain Anomaly Detection as a Bayesian Inverse Problem with Diffusion Prior](https://arxiv.org/abs/2609.24265)
...
### [178] [How Many Pixels Is a Digit Worth? Place-Aware Coordinate Entropy for GUI Agent Confidence Estimation](https://arxiv.org/abs/2609.24277)
...
### [179] [When and How Should an Agent Clarify? CIGAsk: Teaching LLMs to Clarify via Counterfactual Information Gain](https://arxiv.org/abs/2609.24290)
*Yunxiang Li,Xixin Wu,Helen Meng*
...
### [180] [Brain-Token Learning: Microstate-Based Tokenization and Multi-Scale Interaction for Long-Horizon EEG Sequence Modeling](https://arxiv.org/abs/2609.24324)
...
### [181] [LADDER: Graph-Guided Diffusion Language Models for Efficient Multi-Hop Reasoning](https://arxiv.org/abs/2609.24346)
...
### [182] [Few-Shot Demonstrations Elicit the Use of In-Context World Representations in LLMs](https://arxiv.org/abs/2609.24352)
...
### [183] [VLM-in-Sandbox: Visual Workspaces for Agentic Visual Reasoning](https://arxiv.org/abs/2609.24362)
...
### [184] [Predicting Postprandial Glycemic Response from Meal Images, Clinical Variables, and Gut Microbiome Information](https://arxiv.org/abs/2609.24453)
...
### [185] [Fathom-Vaidya: Advancing Medical Reasoning with Rubric-Based Rewards](https://arxiv.org/abs/2609.24480)
...
### [186] [Not All Task Vectors Need Equal Rank: Energy-Proportional Allocation for Model Merging](https://arxiv.org/abs/2609.24517)
...
### [187] [The Endless Exam: Mathematical Constructions from Today's Models toward Superintelligence](https://arxiv.org/abs/2609.24555)
*Muhan Zhang*
...
### [188] [Ascent: An Agentic System over the Model Context Protocol for Real-World Clinical Data Analysis](https://arxiv.org/abs/2609.24620)
...
### [189] [Custom Named Entity Recognition and Topic Classification for Global Health Publications](https://arxiv.org/abs/2609.24625)
...
### [190] [DUMA-Bench: A Dual-Control Multi-Agent Benchmark for Evaluating LLM Agent Security](https://arxiv.org/abs/2609.24662)
...
### [191] [Beyond Endpoint Performance: Process-Level Evaluation of Self-Evolving Agents](https://arxiv.org/abs/2609.24663)
...
### [192] [TimeLitmus: A Diagnostic Benchmark for Cross-Modal Understanding and Explanation Faithfulness in Event-Conditioned Time-Series Prediction](https://arxiv.org/abs/2609.24677)
...
### [193] [World State Generator](https://arxiv.org/abs/2609.24744)
...
### [194] [Epi-Logic: A Conceptual Framework for Epistemic Runtime Control, Schema Validity Checking, and Controlled Accommodation in Autonomous AI Agents](https://arxiv.org/abs/2609.24755)
*Boris Wetzk*
...
### [195] [Construting Reverse Thinking: Developing Large Language Models' Reverse Thingking Ability](https://arxiv.org/abs/2609.24760)
...
### [196] [Convex AI Compositionality and the Governance of AI System Populations](https://arxiv.org/abs/2609.24784)
*Andrea Ferrario*
...
### [197] [GRUET: Quantifying Uncertainty of Agentic Reasoning-and-Acting Processes](https://arxiv.org/abs/2609.24831)
...
### [198] [MedRSI: Recursive Self-Improvement for Medical Agents via Clinically Aligned Self-Evolution](https://arxiv.org/abs/2609.24838)
...
### [199] [Extracting Arguments, Not Just Classifying Them: Instruction-Tuned LLMs for Generative Component Detection](https://arxiv.org/abs/2609.24855)
...
### [200] [Partner-Specific Affective Precision in Social Active Inference](https://arxiv.org/abs/2609.24876)
...
### [201] [Pinocchio: Fast Uncertainty Estimates for Black-Box Language Models](https://arxiv.org/abs/2609.24881)
...
### [202] [A Global Comparison of Schemas, Transparency, and Interoperability in Public-Sector AI Registers and Inventories](https://arxiv.org/abs/2609.24883)
...
### [203] [BackTrend: Evaluating Scientific Weak-Signal Prediction via Backward Reconstruction](https://arxiv.org/abs/2609.24921)
...
### [204] [Et Tu, Brute? Economic Misalignment in Personal AI Agents](https://arxiv.org/abs/2609.24927)
...
### [205] [Emergent Collusion in Long-Horizon LLM Agent Interaction](https://arxiv.org/abs/2609.24967)
...
### [206] [Harness-Zero: Harness Distillation via Agent-as-Harness](https://arxiv.org/abs/2609.24974)
