...
### [9] [Towards a Systematic Risk Assessment of Deep Neural Network Limitations in Autonomous Driving Perception](https://arxiv.org/abs/2604.20895)
...
### [10] [Sensitivity Uncertainty Alignment in Large Language Models](https://arxiv.org/abs/2604.20903)
...
### [11] [Omission Constraints Decay While Commission Constraints Persist in Long-Context LLM Agents](https://arxiv.org/abs/2604.20911)
*Yeran Gamage*
...
### [12] [Hidden Secrets in the arXiv: Discovering, Analyzing, and Preventing Unintentional Information Disclosure in Source Files of Scientific Preprints](https://arxiv.org/abs/2604.20927)
...
### [13] [SafeRedirect: Defeating Internal Safety Collapse via Task-Completion Redirection in Frontier LLMs](https://arxiv.org/abs/2604.20930)
...
### [14] [Adaptive Defense Orchestration for RAG: A Sentinel-Strategist Architecture against Multi-Vector Attacks](https://arxiv.org/abs/2604.20932)
...
### [15] [SDNGuardStack: An Explainable Ensemble Learning Framework for High-Accuracy Intrusion Detection in Software-Defined Networks](https://arxiv.org/abs/2604.20934)
...
### [20] [Behavioral Consistency and Transparency Analysis on Large Language Model API Gateways](https://arxiv.org/abs/2604.21083)
...
### [21] [Cross-Session Threats in AI Agents: Benchmark, Evaluation, and Algorithms](https://arxiv.org/abs/2604.21131)
*Ari Azarafrooz*
...
### [22] [Image-Based Malware Type Classification on MalNet-Image Tiny: Effects of Multi-Scale Fusion, Transfer Learning, Data Augmentation, and Schedule-Free Optimization](https://arxiv.org/abs/2604.21153)
...
### [23] [Adaptive Instruction Composition for Automated LLM Red-Teaming](https://arxiv.org/abs/2604.21159)
...
### [24] [Position Paper: Denial-of-Service Against Multi-Round Transaction Simulation](https://arxiv.org/abs/2604.21169)
...
### [25] [Physically Unclonable Functions for Secure IoT Authentication and Hardware-Anchored AI Model Integrity](https://arxiv.org/abs/2604.21188)
...
### [26] [ECCFROG522PP: An Enhanced 522 bit Weierstrass Elliptic Curve](https://arxiv.org/abs/2604.21261)
*Victor Duarte Melo*
...
### [27] [Strategic Heterogeneous Multi-Agent Architecture for Cost-Effective Code Vulnerability Detection](https://arxiv.org/abs/2604.21282)
...
### [28] [CI-Work: Benchmarking Contextual Integrity in Enterprise LLM Agents](https://arxiv.org/abs/2604.21308)
...
### [29] [Adversarial Evasion in Non-Stationary Malware Detection: Minimizing Drift Signals through Similarity-Constrained Perturbations](https://arxiv.org/abs/2604.21310)
...
### [30] [Provably Secure Steganography Based on List Decoding](https://arxiv.org/abs/2604.21394)
...
### [31] [CSC: Turning the Adversary's Poison against Itself](https://arxiv.org/abs/2604.21416)
...
### [32] [Differentially Private De-identification of Dutch Clinical Notes: A Comparative Evaluation](https://arxiv.org/abs/2604.21421)
...
### [34] [MCP Pitfall Lab: Exposing Developer Pitfalls in MCP Tool Server Security under Multi-Vector Attacks](https://arxiv.org/abs/2604.21477)
*Run Hao,Zhuoran Tan*
...
### [35] [Benchmarking the Utility of Privacy-Preserving Cox Regression Under Data-Driven Clipping Bounds: A Multi-Dataset Simulation Study](https://arxiv.org/abs/2604.21491)
...
### [36] [Mitigate or Fail: How Risk Management Shapes Cybersecurity Competency](https://arxiv.org/abs/2604.21604)
*Jeffrey T. Gardiner*
...
### [37] [Process-Mining of Hypertraces: Enabling Scalable Formal Security Verification of (Automotive) Network Architectures](https://arxiv.org/abs/2604.21606)
...
### [38] [A-THENA: Early Intrusion Detection for IoT with Time-Aware Hybrid Encoding and Network-Specific Augmentation](https://arxiv.org/abs/2604.21623)
...
### [39] [On the Challenges of Holistic Intrusion Detection in ICS](https://arxiv.org/abs/2604.21626)
...
### [40] [A Sociotechnical, Practitioner-Centered Approach to Technology Adoption in Cybersecurity Operations: An LLM Case](https://arxiv.org/abs/2604.21679)
...
### [41] [Stealthy Backdoor Attacks against LLMs Based on Natural Style Triggers](https://arxiv.org/abs/2604.21700)
...
### [42] [Adversarial Robustness of Near-Field Millimeter-Wave Imaging under Waveform-Domain Attacks](https://arxiv.org/abs/2604.21774)
...
### [43] [Black-Box Skill Stealing Attack from Proprietary LLM Agents: An Empirical Study](https://arxiv.org/abs/2604.21829)
...
### [44] [TraceScope: Interactive URL Triage via Decoupled Checklist Adjudication](https://arxiv.org/abs/2604.21840)
...
### [45] [Cross-Modal Phantom: Coordinated Camera-LiDAR Spoofing Against Multi-Sensor Fusion in Autonomous Vehicles](https://arxiv.org/abs/2604.21841)
...
### [46] [Transient Turn Injection: Exposing Stateless Multi-Turn Vulnerabilities in Large Language Models](https://arxiv.org/abs/2604.21860)
...
### [47] [CrossCommitVuln-Bench: A Dataset of Multi-Commit Python Vulnerabilities Invisible to Per-Commit Static Analysis](https://arxiv.org/abs/2604.21917)
*Arunabh Majumdar*
...
### [48] [Ternary Memristive Logic: Hardware for Reasoning Realized via Domain Algebra](https://arxiv.org/abs/2604.20891)
*Chao Li*
...
### [49] [AnalogMaster: Large Language Model-based Automated Analog IC Design Framework from Image to Layout](https://arxiv.org/abs/2604.20916)
...
### [50] [Efficient Batch Search Algorithm for B+ Tree Index Structures with Level-Wise Traversal on FPGAs](https://arxiv.org/abs/2604.21117)
...
### [51] [Enabling Mixed criticality applications for the Versal AI-Engines](https://arxiv.org/abs/2604.21124)
...
### [63] [Mind the Prompt: Self-adaptive Generation of Task Plan Explanations via LLMs](https://arxiv.org/abs/2604.21092)
...
### [64] [Propensity Inference: Environmental Contributors to LLM Behaviour](https://arxiv.org/abs/2604.21098)
...
### [65] [AI Governance under Political Turnover: The Alignment Surface of Compliance Design](https://arxiv.org/abs/2604.21103)
*Andrew J. Peterson*
...
### [66] [Agentic AI for Personalized Physiotherapy: A Multi-Agent Framework for Generative Video Training and Real-Time Pose Correction](https://arxiv.org/abs/2604.21154)
...
### [67] [Multi-Agent Empowerment and Emergence of Complex Behavior in Groups](https://arxiv.org/abs/2604.21155)
...
### [68] [Trust but Verify: Introducing DAVinCI -- A Framework for Dual Attribution and Verification in Claim Inference for Language Models](https://arxiv.org/abs/2604.21193)
...
### [69] [Align Generative Artificial Intelligence with Human Preferences: A Novel Large Language Model Fine-Tuning Method for Online Review Management](https://arxiv.org/abs/2604.21209)
*Yanan Wang,Yong Ge*
...
### [70] [ReCAPA: Hierarchical Predictive Correction to Mitigate Cascading Failures](https://arxiv.org/abs/2604.21232)
...
### [71] [Robustness Analysis of POMDP Policies to Observation Perturbations](https://arxiv.org/abs/2604.21256)
...
### [72] [Trustworthy Clinical Decision Support Using Meta-Predicates and Domain-Specific Languages](https://arxiv.org/abs/2604.21263)
...
### [73] [Enhancing Online Recruitment with Category-Aware MoE and LLM-based Data Augmentation](https://arxiv.org/abs/2604.21264)
...
### [76] [Ideological Bias in LLMs' Economic Causal Reasoning](https://arxiv.org/abs/2604.21334)
...
### [77] [Evaluating AI Meeting Summaries with a Reusable Cross-Domain Pipeline](https://arxiv.org/abs/2604.21345)
...
### [78] [Symbolic Grounding Reveals Representational Bottlenecks in Abstract Visual Reasoning](https://arxiv.org/abs/2604.21346)
...
### [79] [ReaGeo: Reasoning-Enhanced End-to-End Geocoding with LLMs](https://arxiv.org/abs/2604.21357)
...
### [80] [Time, Causality, and Observability Failures in Distributed AI Inference Systems](https://arxiv.org/abs/2604.21361)
...
### [81] [SemanticAgent: A Semantics-Aware Framework for Text-to-SQL Data Synthesis](https://arxiv.org/abs/2604.21414)
...
### [82] [FairQE: Multi-Agent Framework for Mitigating Gender Bias in Translation Quality Estimation](https://arxiv.org/abs/2604.21420)
...
### [83] [Brief chatbot interactions produce lasting changes in human moral values](https://arxiv.org/abs/2604.21430)
...
### [85] [AI-Gram: When Visual Agents Interact in a Social Network](https://arxiv.org/abs/2604.21446)
*Andrew Shin*
...
### [86] [Efficient Agent Evaluation via Diversity-Guided User Simulation](https://arxiv.org/abs/2604.21480)
...
### [90] [The CriticalSet problem: Identifying Critical Contributors in Bipartite Dependency Networks](https://arxiv.org/abs/2604.21537)
...
### [93] [Probabilistic Verification of Neural Networks via Efficient Probabilistic Hull Generation](https://arxiv.org/abs/2604.21556)
...
### [94] [Separable Expert Architecture: Toward Privacy-Preserving LLM Personalization via Composable Adapters and Deletable User Proxies](https://arxiv.org/abs/2604.21571)
...
### [95] [CoFEE: Reasoning Control for LLM-Based Feature Discovery](https://arxiv.org/abs/2604.21584)
...
### [96] [To See the Unseen: on the Generalization Ability of Transformers in Symbolic Reasoning](https://arxiv.org/abs/2604.21632)
...
### [97] [GS-Quant: Granular Semantic and Generative Structural Quantization for Knowledge Graph Completion](https://arxiv.org/abs/2604.21649)
...
### [98] [Enabling and Inhibitory Pathways of University Students' Willingness to Disclose AI Use: A Cognition-Affect-Conation Perspective](https://arxiv.org/abs/2604.21733)
*Yiran Du,Huimin He*
...
### [99] [Bridging the Training-Deployment Gap: Gated Encoding and Multi-Scale Refinement for Efficient Quantization-Aware Image Enhancement](https://arxiv.org/abs/2604.21743)
...
### [100] [Thinking with Reasoning Skills: Fewer Tokens, More Accuracy](https://arxiv.org/abs/2604.21764)
...
### [101] [Who Defines "Best"? Towards Interactive, User-Defined Evaluation of LLM Leaderboards](https://arxiv.org/abs/2604.21769)
...
### [102] [Inferring High-Level Events from Timestamped Data: Complexity and Medical Applications](https://arxiv.org/abs/2604.21793)
...
### [103] [Learning to Communicate: Toward End-to-End Optimization of Multi-Agent Language Systems](https://arxiv.org/abs/2604.21794)
...
### [104] [Alignment has a Fantasia Problem](https://arxiv.org/abs/2604.21827)
...
### [105] [Bounding the Black Box: A Statistical Certification Framework for AI Risk Regulation](https://arxiv.org/abs/2604.21854)
...
### [106] [Nemobot Games: Crafting Strategic AI Gaming Agents for Interactive Learning with Large Language Models](https://arxiv.org/abs/2604.21896)
...
### [107] [From Research Question to Scientific Workflow: Leveraging Agentic AI for Science Automation](https://arxiv.org/abs/2604.21910)
