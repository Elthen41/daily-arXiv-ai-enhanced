...
### [3] [Partitioned Tags, Shared Data: Reconciling Strict Cache Isolation with Write-Shared Coherence](https://arxiv.org/abs/2606.12259)
...
### [4] [JailbreakOPT: Tool-Assisted Iterative Jailbreak Prompt Optimization](https://arxiv.org/abs/2606.11425)
...
### [5] [Evaluating and Combating the Impact of Concept Drift on the Performance of Machine Learning-Based Phishing Detection Systems](https://arxiv.org/abs/2606.11471)
...
### [6] [Hiding the Trees in the Forest: Building Network Covert Channels with Hash-Based Covert Carrier Filtering](https://arxiv.org/abs/2606.11532)
...
### [7] [VIPIR: A Versatile GPU Framework for Integrating Private Information Retrieval Protocols](https://arxiv.org/abs/2606.11536)
...
### [8] [PriME-Deal: Privacy-Preserving Bilateral Data Trading with Efficient Matchmaking and Auditable Fair Exchange on Blockchain](https://arxiv.org/abs/2606.11539)
...
### [9] [WHET: Welding Homomorphic Encryption to Accelerator Architectures](https://arxiv.org/abs/2606.11541)
...
### [10] [Privacy-Preserving Federated Autoencoder for ECG Anomaly Detection on Edge Devices](https://arxiv.org/abs/2606.11556)
...
### [11] [Sovereign Assurance Boundary: Certificate-Bound Admission for Agentic Infrastructure](https://arxiv.org/abs/2606.11632)
*Jun He,Deying Yu*
...
### [12] [A Deterministic Forensic Preprocessing Framework for Heterogeneous Network Datasets: Formal Foundations, Implementation, and Empirical Validation](https://arxiv.org/abs/2606.11565)
...
### [13] [MHOT: Height-Optimized Authenticated Data Structure for Blockchain State Commitment](https://arxiv.org/abs/2606.11736)
...
### [14] [Defense Against Prompt Inversion Attacks: An Information-Theoretic Approach for LLM Collaborative Inference](https://arxiv.org/abs/2606.11592)
...
### [15] [Dummy Backdoor as a Defense: Removing Unknown Backdoors via Shared Internal Mechanisms for Generative LLMs](https://arxiv.org/abs/2606.11648)
...
### [17] [Runtime Skill Audit: Targeted Runtime Probing for Agent Skill Security](https://arxiv.org/abs/2606.11671)
*Tu Lan,Chaowei Xiao*
...
### [18] [Can Open-Source LLM Agents Replace Static Application Security Testing Tools? An Empirical Assessment](https://arxiv.org/abs/2606.11672)
...
### [19] [T2S: A Rehearsal-Based Approach for Extraction-Resistant Model Watermarking](https://arxiv.org/abs/2606.11698)
...
### [20] [A VPN-as-a-Service Tailored Enabler for Computing-constrained Environments](https://arxiv.org/abs/2606.11729)
...
### [22] [Grammar-Constrained Decoding Can Jailbreak LLMs into Generating Malicious Code](https://arxiv.org/abs/2606.11817)
...
### [23] [Jaguar: Fast Private CNN Inference with Power-of-Two Homomorphic Arithmetic](https://arxiv.org/abs/2606.11827)
...
### [24] [Systematic Cybersecurity Risk Analysis of European Rail Traffic Management System](https://arxiv.org/abs/2606.11839)
...
### [25] [WarpGuard: Protected-Site Control-Flow Integrity for CUDA SASS Binaries](https://arxiv.org/abs/2606.11871)
*Igor Santos-Grueiro*
...
### [26] [Gerrymandering the Warp: Non-Control-Data Attacks on CUDA Collective Decision](https://arxiv.org/abs/2606.11878)
*Igor Santos-Grueiro*
...
### [27] [Quadratic APN Functions in Dimension 8 via Gröbner Basis Search in a Self-Equivalence Subspace](https://arxiv.org/abs/2606.11967)
*Oleksandr Kuznetsov*
...
### [28] [InjectV: Modeling Fault Injection Attacks in RISC-V Simulation Environment](https://arxiv.org/abs/2606.12011)
...
### [29] [Categorical Robustness Assessment for Machine Learning based Network Intrusion Detection Systems](https://arxiv.org/abs/2606.12075)
...
### [30] [Bridging the Smart City Cybersecurity Data Gap Through AI-Driven Synthetic Dataset Generation](https://arxiv.org/abs/2606.12225)
...
### [35] [TileFuse: A Fused Mixed-Precision Kernel Library for Efficient Quantized LLM Inference on AMD NPUs](https://arxiv.org/abs/2606.11357)
...
### [36] [Beyond Per-Token Pricing: A Concurrency-Aware Methodology for LLM Infrastructure Cost Estimation](https://arxiv.org/abs/2606.11690)
*Chitral Patil*
...
### [37] [Consensus Time in 3-Majority and 2-Choices Is Determined by the Maximum Initial Opinion Density](https://arxiv.org/abs/2606.11778)
*Niccolò D Archivio*
...
### [38] [Optimizing Cloud Deployment: Blending of IaaS and FaaS for Microservice Architecture](https://arxiv.org/abs/2606.11824)
...
### [39] [Harnessing Routing Foresight for Micro-step-level MoE load balancing in RL Post-training](https://arxiv.org/abs/2606.11867)
...
### [40] [From Fork-Join to Asynchronous Tasks: Parallelizing Tiled Cholesky Decomposition with OpenMP and HPX](https://arxiv.org/abs/2606.11937)
...
### [41] [The PM-EdgeMap: Towards Real-Time Process Mining on the Edge-Cloud Continuum](https://arxiv.org/abs/2606.12103)
...
### [42] [Efficient and Robust Online Learning to Rank in Decentralized Systems](https://arxiv.org/abs/2606.12246)
...
### [43] [Fair Comparison of Scheduling Algorithms on Heterogeneous Edge Clusters: A Continuous Adaptive Benchmark](https://arxiv.org/abs/2606.12343)
...
### [44] [From Explicit Elements to Implicit Intent: A Predefined Library for Auditable Behavioral Inference](https://arxiv.org/abs/2606.11207)
*Liu hung ming*
...
### [45] [Position: Hippocampal Explicit Memory Is the Cornerstone for AGI](https://arxiv.org/abs/2606.11245)
*Sangjun Park*
...
### [46] [Can AI Agents Synthesize Scientific Conclusions?](https://arxiv.org/abs/2606.11337)
...
### [47] [Knowing When to Ask: Self-Gated Clarification for Hierarchical Language Agents](https://arxiv.org/abs/2606.11349)
...
### [48] [Automated Mediator for Human Negotiation: Pre-Mediation via a Structured LLM Pipeline](https://arxiv.org/abs/2606.11379)
...
### [50] [Forecasting Future Behavior as a Learning Task](https://arxiv.org/abs/2606.11445)
...
### [51] [Search Discipline for Long-Horizon Research Agents](https://arxiv.org/abs/2606.11522)
...
### [52] [MoCA-Agent: A Market-of-Claims Code Agent for Financial and Numerical Reasoning](https://arxiv.org/abs/2606.11537)
...
### [53] [SkillJuror: Measuring How Agent Skill Organization Changes Runtime Behavior](https://arxiv.org/abs/2606.11543)
...
### [54] [HERO: Hindsight-Enhanced Reflection from Environment Observations for Agentic Self-Distillation](https://arxiv.org/abs/2606.11559)
...
### [56] [TouchThinker: Scaling Tactile Commonsense Reasoning to the Open World with Large-scale Data and Action-aware Representation](https://arxiv.org/abs/2606.11637)
...
### [57] [TreeSeeker: Tree-Structured Trial, Error, and Return in Deep Search](https://arxiv.org/abs/2606.11662)
...
### [58] [Lung-R1: A Knowledge Graph-Guided LLM for Pulmonary Diagnostic Reasoning](https://arxiv.org/abs/2606.11675)
...
### [64] [Skill-Augmented AI Agents for Medical Research Analysis: An Exploratory Multi-Model Human Evaluation in an NSCLC Transcriptomic Biomarker Task](https://arxiv.org/abs/2606.11830)
...
### [65] [StatefulDiscovery: Evidence-Calibrated Claim Formation in Open-Ended Scientific Discovery](https://arxiv.org/abs/2606.11851)
...
### [66] [AutoMine Solution for AV2 2026 Scenario Mining Challenge](https://arxiv.org/abs/2606.11874)
...
### [67] [Embodied-BenchClaw: An Autonomous Multi-Agent System for Embodied Spatial Intelligence Benchmark Construction](https://arxiv.org/abs/2606.11909)
...
### [68] [The Art of Interrogation: Consistency Amplifies Factuality in Spatial Reasoning](https://arxiv.org/abs/2606.11918)
...
### [69] [MODF-SIR: A Multi-agent Omni-modal Distilled Framework for Social Intelligence Reasoning](https://arxiv.org/abs/2606.12018)
...
### [70] [Human-Enhanced Loop Modeling (HELM): Agent-Based Finite Element Modeling of Concrete Bridge Barriers](https://arxiv.org/abs/2606.12025)
...
### [71] [Existential Indifference: Self-Nonpreservation as a Necessary Architectural Condition for Aligned Superintelligence (or: The Suicidal AI)](https://arxiv.org/abs/2606.12032)
*Sam Mao*
...
### [72] [A Lightweight Multi-Agent Framework for Automated Concrete Barrier Design](https://arxiv.org/abs/2606.12040)
...
### [73] [Automating Geometry-Intensive Compliance Checking in BIM: Graph-Based Semantic Reasoning Framework](https://arxiv.org/abs/2606.12065)
...
### [74] [IntElicit: Eliciting and Assessing Contextualized Creativity via Dialogue Policy Optimization](https://arxiv.org/abs/2606.12086)
...
### [75] [Towards Responsibly Non-Compliant Machines](https://arxiv.org/abs/2606.12147)
...
### [76] [The Impossibility of Eliciting Latent Knowledge](https://arxiv.org/abs/2606.12268)
...
### [77] [A Five-Plane Reference Architecture for Runtime Governance of Production AI Agents](https://arxiv.org/abs/2606.12320)
*Krti Tallam*
...
### [78] [PROJECTMEM: A Local-First, Event-Sourced Memory and Judgment Layer for AI Coding Agents](https://arxiv.org/abs/2606.12329)
...
### [79] [Nonslop: A Gamified Experiment in Human-AI Collaborative Writing](https://arxiv.org/abs/2606.12350)
...
### [80] [SPEAR: A System for Post-Quantization Error-Adaptive Recovery Enabling Efficient Low-Bit LLM Serving](https://arxiv.org/abs/2606.11244)
...
### [81] [A Fast Locality Simulator for GEMM Design-Space Exploration on Multi-Chiplet GPUs](https://arxiv.org/abs/2606.11716)
...
### [82] [Making Locality-aware GEMM Compatible with Page-Granularity Placement on Chiplet GPUs](https://arxiv.org/abs/2606.11718)
...
### [83] [BenDi: An Energy-Efficient Quasi-Stochastic Systolic Architecture for Edge Bioelectronics](https://arxiv.org/abs/2606.12235)
