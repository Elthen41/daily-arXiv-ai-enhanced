...
### [3] [LIPPEN: A Lightweight In-Place Pointer Encryption Architecture for Pointer Integrity](https://arxiv.org/abs/2605.03974)
...
### [5] [Tracing the Dynamics of Refusal: Exploiting Latent Refusal Trajectories for Robust Jailbreak Detection](https://arxiv.org/abs/2605.02958)
...
### [6] [Decompose to Understand, Fuse to Detect: Frequency-Decoupled Anomaly Detection for Encrypted Network Traffic](https://arxiv.org/abs/2605.02970)
...
### [7] [Contrastive Privacy: A Semantic Approach to Measuring Privacy of AI-based Sanitization](https://arxiv.org/abs/2605.02977)
...
### [8] [Observability for Post-Quantum TLS Readiness: A Multi-Surface Evidence Framework](https://arxiv.org/abs/2605.02978)
*José Luis Delgado*
...
### [9] [Towards a Risk-Cost Model for Financial Adaptive Authentication](https://arxiv.org/abs/2605.02979)
...
### [10] [SoK: After Decades of Web Tracker Detection, What's Next?](https://arxiv.org/abs/2605.02982)
...
### [11] [LiteShield: Hybrid Feature Selection-Driven Lightweight Intrusion Detection for Resource-Constrained IoT Networks](https://arxiv.org/abs/2605.02987)
...
### [12] [ChaRVoC: A Challenge-Response Voice Cancelable Authentication System](https://arxiv.org/abs/2605.02990)
...
### [13] [PHANTOM: Polymorphic Honeytoken Adaptation with Narrative-Tailored Organisational Mimicry](https://arxiv.org/abs/2605.02992)
...
### [14] [Distributed Deep Variational Approach for Privacy-preserving Data Release](https://arxiv.org/abs/2605.03069)
...
### [15] [Revisiting JBShield: Breaking and Rebuilding Representation-Level Jailbreak Defenses](https://arxiv.org/abs/2605.03095)
...
### [16] [PIIGuard: Mitigating PII Harvesting under Adversarial Sanitization](https://arxiv.org/abs/2605.03129)
...
### [17] [Zero Day Attacks: Novel Behaviour or Novel Vulnerability?](https://arxiv.org/abs/2605.03138)
...
### [18] [Evaluating Retrieval-Augmented Generation for Explainable Malware Analysis](https://arxiv.org/abs/2605.03140)
...
### [19] [HackerSignal: A Large-Scale Multi-Source Dataset Linking Hacker Community Discourse to the CVE Vulnerability Lifecycle](https://arxiv.org/abs/2605.03158)
...
### [20] [A Validated Prompt Bank for Malicious Code Generation: Separating Executable Weapons from Security Knowledge in 1,554 Consensus-Labeled Prompts](https://arxiv.org/abs/2605.03179)
...
### [21] [Dependency-Aware Privacy for Multi-turn Agents](https://arxiv.org/abs/2605.03188)
...
### [22] [When Agents Handle Secrets: A Survey of Confidential Computing for Agentic AI](https://arxiv.org/abs/2605.03213)
...
### [23] [MAGE: Safeguarding LLM Agents against Long-Horizon Threats via Shadow Memory](https://arxiv.org/abs/2605.03228)
...
### [24] [SILMARILS: Information-Theoretic and Quantum-Secure Designated-Verifier Signatures](https://arxiv.org/abs/2605.03230)
...
### [25] [Cryptographic Registry Provenance: Structural Defense Against Dependency Confusion in AI Package Ecosystems](https://arxiv.org/abs/2605.03309)
*Alan L. McCann*
...
### [26] [SkCC: Portable and Secure Skill Compilation for Cross-Framework LLM Agents](https://arxiv.org/abs/2605.03353)
...
### [27] [ARGUS: Defending LLM Agents Against Context-Aware Prompt Injection](https://arxiv.org/abs/2605.03378)
...
### [28] [DECKER: Domain-invariant Embedding for Cross-Keyboard Extraction and Recognition](https://arxiv.org/abs/2605.03384)
...
### [29] [Exposing LLM Safety Gaps Through Mathematical Encoding:New Attacks and Systematic Analysis](https://arxiv.org/abs/2605.03441)
...
### [30] [MEMSAD: Gradient-Coupled Anomaly Detection for Memory Poisoning in Retrieval-Augmented Agents](https://arxiv.org/abs/2605.03482)
*Ishrith Gowda*
...
### [31] [ZK-Value: A Practical Zero-Knowledge System for Verifiable Data Valuation](https://arxiv.org/abs/2605.03581)
...
### [32] [The Infinite Mutation Engine? Measuring Polymorphism in LLM-Generated Offensive Code](https://arxiv.org/abs/2605.03619)
...
### [33] [Tailored Prompts, Targeted Protection: Vulnerability-Specific LLM Analysis for Smart Contracts](https://arxiv.org/abs/2605.03697)
...
### [34] [Internet of Things Security: A Survey on Common Attacks](https://arxiv.org/abs/2605.03744)
...
### [35] [GPUBreach: Privilege Escalation Attacks on GPUs using Rowhammer](https://arxiv.org/abs/2605.03812)
...
### [36] [HELO Cryptography: A Lightweight Cryptographic System for Enhancing IoT Security in P2P Data Transmission](https://arxiv.org/abs/2605.03948)
...
### [37] [MOSAIC-Bench: Measuring Compositional Vulnerability Induction in Coding Agents](https://arxiv.org/abs/2605.03952)
...
### [38] [Generating Proof-of-Vulnerability Tests to Help Enhance the Security of Complex Software](https://arxiv.org/abs/2605.03956)
...
### [39] [Probabilistic-bit Guided CDCL for SAT Solving using Ising Consensus Assumptions](https://arxiv.org/abs/2605.04033)
*Melki Bino*
...
### [40] [From Barrier to Bridge: The Case for AI Data Center/Power Grid Co-Design](https://arxiv.org/abs/2605.03090)
...
### [41] [VDCores: Resource Decoupled Programming and Execution for Asynchronous GPU](https://arxiv.org/abs/2605.03190)
...
### [42] [On Solving Problems of Substantially Super-linear Complexity in $N^{o(1)}$ Rounds in the MPC Model](https://arxiv.org/abs/2605.03376)
*Andrzej Lingas*
...
### [43] [Enhancing Performance Insight at Scale: A Heterogeneous Framework for Exascale Diagnostics](https://arxiv.org/abs/2605.03561)
*Dragana Grbic*
...
### [44] [Lifting to tensors when compiling scientific computing workloads for AI Engines](https://arxiv.org/abs/2605.03566)
...
### [45] [A Workflow-Oriented Framework for Asynchronous Human-AI Collaboration in Hybrid and Compute-Intensive HPC Environments](https://arxiv.org/abs/2605.03743)
...
### [46] [Implementing True MPI Sessions and Evaluating MPI Initialization Scalability](https://arxiv.org/abs/2605.03983)
...
### [47] [CreativityBench: Evaluating Agent Creative Reasoning via Affordance-Based Tool Repurposing](https://arxiv.org/abs/2605.02910)
...
### [48] [Stable Agentic Control: Tool-Mediated LLM Architecture for Autonomous Cyber Defense](https://arxiv.org/abs/2605.03034)
...
### [49] [Computing Thiele Rules on Interval Elections and their Generalizations](https://arxiv.org/abs/2605.03067)
...
### [50] [Making the Invisible Visible: Understanding the Mismatch Between Organizational Goals and Worker Experiences in AI Adoption](https://arxiv.org/abs/2605.03078)
...
### [51] [Programmatic Context Augmentation for LLM-based Symbolic Regression](https://arxiv.org/abs/2605.03101)
...
### [52] [Learning Correct Behavior from Examples: Validating Sequential Execution in Autonomous Agents](https://arxiv.org/abs/2605.03159)
...
### [53] [Terminus-4B: Can a Smaller Model Replace Frontier LLMs at Agentic Execution Tasks?](https://arxiv.org/abs/2605.03195)
...
### [54] [Stop Automating Peer Review Without Rigorous Evaluation](https://arxiv.org/abs/2605.03202)
...
### [55] [ADAPTS: Agentic Decomposition for Automated Protocol-agnostic Tracking of Symptoms](https://arxiv.org/abs/2605.03212)
...
### [56] [Evaluating Prompting and Execution-Based Methods for Deterministic Computation in LLMs](https://arxiv.org/abs/2605.03227)
*Hongkun Yu*
...
### [57] [cotomi Act: Learning to Automate Work by Watching You](https://arxiv.org/abs/2605.03231)
...
### [61] [What Happens Inside Agent Memory? Circuit Analysis from Emergence to Diagnosis](https://arxiv.org/abs/2605.03354)
...
### [62] [ReasonAudio: A Benchmark for Evaluating Reasoning Beyond Matching in Text-Audio Retrieval](https://arxiv.org/abs/2605.03361)
...
### [64] [Robust Agent Compensation (RAC): Teaching AI Agents to Compensate](https://arxiv.org/abs/2605.03409)
...
### [65] [Geometry over Density: Few-Shot Cross-Domain OOD Detection](https://arxiv.org/abs/2605.03410)
...
### [66] [Adaptive Dual-Path Framework for Covert Semantic Communication](https://arxiv.org/abs/2605.03423)
...
### [67] [Replacing Parameters with Preferences: Federated Alignment of Heterogeneous Vision-Language Models](https://arxiv.org/abs/2605.03426)
...
### [68] [FinSTaR: Towards Financial Reasoning with Time Series Reasoning Models](https://arxiv.org/abs/2605.03460)
...
### [69] [Real-Time Evaluation of Autonomous Systems under Adversarial Attacks](https://arxiv.org/abs/2605.03491)
...
### [70] [Workspace-Bench 1.0: Benchmarking AI Agents on Workspace Tasks with Large-Scale File Dependencies](https://arxiv.org/abs/2605.03596)
...
### [71] [Where Paths Split: Localized, Calibrated Control of Moral Reasoning in Large Language Models](https://arxiv.org/abs/2605.03609)
...
### [72] [Self-Improvement for Fast, High-Quality Plan Generation](https://arxiv.org/abs/2605.03625)
...
### [73] [AdapShot: Adaptive Many-Shot In-Context Learning with Semantic-Aware KV Cache Reuse](https://arxiv.org/abs/2605.03644)
...
### [74] [Agent-Based Modeling of Low-Emission Fertilizer Adoption for Dairy Farm Decarbonisation using Empirical Farm Data](https://arxiv.org/abs/2605.03648)
...
### [75] [OracleProto: A Reproducible Framework for Benchmarking LLM Native Forecasting via Knowledge Cutoff and Temporal Masking](https://arxiv.org/abs/2605.03762)
...
### [76] [What You Think is What You See: Driving Exploration in VLM Agents via Visual-Linguistic Curiosity](https://arxiv.org/abs/2605.03782)
...
### [77] [Say the Mission, Execute the Swarm: Agent-Enhanced LLM Reasoning in the Web-of-Drones](https://arxiv.org/abs/2605.03788)
...
### [78] [ScrapMem: A Bio-inspired Framework for On-device Personalized Agent Memory via Optical Forgetting](https://arxiv.org/abs/2605.03804)
...
### [79] [Agentic-imodels: Evolving agentic interpretability tools via autoresearch](https://arxiv.org/abs/2605.03808)
...
### [80] [SOAR: Real-Time Joint Optimization of Order Allocation and Robot Scheduling in Robotic Mobile Fulfillment Systems](https://arxiv.org/abs/2605.03842)
...
### [81] [Mechanical Conscience: A Mathematical Framework for Dependability of Machine Intelligenc](https://arxiv.org/abs/2605.03847)
...
### [82] [Correct Is Not Enough: Training Reasoning Planners with Executor-Grounded Rewards](https://arxiv.org/abs/2605.03862)
...
### [83] [Quantifying the human visual exposome with vision language models](https://arxiv.org/abs/2605.03863)
...
### [84] [EvoLM: Self-Evolving Language Models through Co-Evolved Discriminative Rubrics](https://arxiv.org/abs/2605.03871)
...
### [85] [Redefining AI Red Teaming in the Agentic Era: From Weeks to Hours](https://arxiv.org/abs/2605.04019)
...
### [86] [Contextual Multi-Objective Optimization: Rethinking Objectives in Frontier AI Systems](https://arxiv.org/abs/2605.03900)
...
### [87] [From Intent to Execution: Composing Agentic Workflows with Agent Recommendation](https://arxiv.org/abs/2605.03986)
...
### [88] [An Agent-Oriented Pluggable Experience-RAG Skill for Experience-Driven Retrieval Strategy Orchestration](https://arxiv.org/abs/2605.03989)
...
### [89] [SymptomAI: Towards a Conversational AI Agent for Everyday Symptom Assessment](https://arxiv.org/abs/2605.04012)
...
### [90] [OpenSeeker-v2: Pushing the Limits of Search Agents with Informative and High-Difficulty Trajectories](https://arxiv.org/abs/2605.04036)
