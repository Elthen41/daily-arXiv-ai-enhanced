...
### [4] [Mined from Scientific Literature: Process Schemas for Atomic Layer Deposition and Etching in Materials Science](https://arxiv.org/abs/2609.12139)
...
### [5] [Can LLMs in Draft-Verify-Revise Pipelines Resolve Deictic Ambiguity?](https://arxiv.org/abs/2609.12162)
*Obinna I. Ekekezie*
...
### [6] [GLARE: Generative Learning via Adversarial Reward Estimation For Social Dynamics Forecasting](https://arxiv.org/abs/2609.12165)
...
### [7] [Soft Symbol Grounding for Prototypical Concepts](https://arxiv.org/abs/2609.12247)
...
### [8] [Learning Symbolic Constraint Representations from Examples: A Neuro-Symbolic Approach](https://arxiv.org/abs/2609.12267)
...
### [9] [T-GADE: Thermodynamical Generative-AI-Driven Evolution of LLM Artifacts](https://arxiv.org/abs/2609.12286)
...
### [14] [Affective Agent: On-Device Personalized Intervention Reasoning for Wearable Systems](https://arxiv.org/abs/2609.12322)
...
### [15] [LoRA-RC: Reservoir Computing with Low-Rank Adaptation](https://arxiv.org/abs/2609.12327)
*Wenbin Wan*
...
### [16] [Toward Robust Personalized Alignment for LLMs: Mitigating Persona Drift in Multi-Turn Dialogue](https://arxiv.org/abs/2609.12373)
...
### [17] [BlueLM-GUI Technical Report: A Real-Device-Centric Flywheel for Self-Improving Mobile GUI Agents](https://arxiv.org/abs/2609.12394)
...
### [18] [Is Gaussian Splatting Becoming Neural Again? A Taxonomy and Controlled Study of Learned Parameterization](https://arxiv.org/abs/2609.12395)
...
### [19] [Niching Agents in The Core](https://arxiv.org/abs/2609.12398)
...
### [20] [OneLA: Scaling Linear-Attention Decoding to Large Beams in Generative Recommendation](https://arxiv.org/abs/2609.12399)
...
### [21] [Decentralized Evolution of Hexapod Gaits with Independent Leg Controllers](https://arxiv.org/abs/2609.12400)
...
### [22] [Beyond ID Embeddings: Process-Grounded Language Modeling for Cognitive Diagnosis](https://arxiv.org/abs/2609.12403)
...
### [23] [VRL-Bench: Benchmarking agents on computer control tasks under finite trial budgets](https://arxiv.org/abs/2609.12404)
...
### [24] [SoK: Rethinking Jailbreaking in the Era of Agentic AI: Attacks, Defenses, and Practical Consideration](https://arxiv.org/abs/2609.12413)
...
### [25] [Hierarchical Belief Modeling for Zero-Shot Opponent Adaptation in Partially Observable Multi-Agent Navigation](https://arxiv.org/abs/2609.12422)
...
### [26] [LifeFuse-Mem: Lifecycle-Aware State Fusion Against Temporary Overwriting for Long-Term Memory](https://arxiv.org/abs/2609.12436)
...
### [27] [Do LLMs Trust the Accuser or the Accusation? Measuring Belief Shifts in Werewolf](https://arxiv.org/abs/2609.12446)
...
### [28] [EvoRS: On-Policy Self-Evolution of Reward Systems for Open-Ended Reinforcement Learning](https://arxiv.org/abs/2609.12459)
...
### [29] [Beyond Vector Similarity: Hierarchical Context-Aware Graph RAG vs Standard RAG in Enterprise Code Migration](https://arxiv.org/abs/2609.12464)
...
### [30] [TripPattern: A Pattern-based Text Watermarking Method for Large Language Models](https://arxiv.org/abs/2609.12472)
...
### [31] [When Does AI Augment Work? A Workflow-Level Framework for Human-Agent Collaboration](https://arxiv.org/abs/2609.12482)
...
### [45] [Assisted Spatial Cognition Through Vision-Language Models](https://arxiv.org/abs/2609.12747)
...
### [46] [SCQ: Stabilizing Conservative Q-Learning with Sigmoid-Bounded Entropy](https://arxiv.org/abs/2609.12749)
...
### [47] [Unified Agentic Video Editing Across Levels of Complexity and Creativity](https://arxiv.org/abs/2609.12769)
...
### [48] [MPT: Missing Prototype Tracking via Barycentric Reconstruction in Vehicular Federated Learning](https://arxiv.org/abs/2609.12771)
...
### [49] [Interpreting the predictions of neural network classification based on a Taylor Coefficient Analysis (TCA)](https://arxiv.org/abs/2609.12801)
...
### [50] [Scaling Clinical Judgment to Evaluate Medical AI](https://arxiv.org/abs/2609.12822)
...
### [51] [MedRoundsQA: A Persona and Difficulty Aware Evaluation for Multi-Turn Medical Consultations](https://arxiv.org/abs/2609.12851)
...
### [52] [Tracing and Coordinating Cross-Layer Influence for Multimodal Model Merging](https://arxiv.org/abs/2609.12897)
...
### [54] [How Good Are Frontier Models at Physics? Expert Re-Grading Reveals Broken Evaluations and Near-Saturation of Leading Benchmarks](https://arxiv.org/abs/2609.13009)
...
### [56] [Anchoring Clinical Events in Time: UID-Preserving Multimodal Reconstruction and Source-Grounded Adjudication](https://arxiv.org/abs/2609.13062)
...
### [57] [Autonomous Research for Open-Ended Problems: A Case Study on Telecom Ticket Retrieval](https://arxiv.org/abs/2609.13073)
...
### [58] [Embodied-BenchForge: A Closed-Loop Agentic Workflow for Embodied Benchmark Construction](https://arxiv.org/abs/2609.13082)
...
### [59] [CMA-OT: Hierarchical Expert Supervision for Dance-to-Music Generation](https://arxiv.org/abs/2609.13118)
...
### [60] [A Hybrid LSTM-XGBoost Framework for Multi-Horizon Stock Return Prediction Across Diversified Equity Portfolios](https://arxiv.org/abs/2609.13125)
...
### [61] [Rethinking Heterogeneous System Disaggregation for Subquadratic Attention](https://arxiv.org/abs/2609.13134)
...
### [62] [Asynchronous Parallel Search for Exact Multi-Objective Shortest Paths with Versioned Frontier Snapshots and Indexed Dominance Pruning](https://arxiv.org/abs/2609.11944)
...
### [63] [Argus: Orchestrating Cross-Layer GPU Performance Measurements around Semantic Regions](https://arxiv.org/abs/2609.12299)
...
### [64] [Efficient Vision-Language-Action Management and Serving for Robot Factories](https://arxiv.org/abs/2609.12075)
...
### [65] [GreenDirector: carbon- and water-aware workload placement for sustainable computing](https://arxiv.org/abs/2609.12602)
...
### [66] [RoofLang: Enabling AI-Driven Architecting of LLM Inference Systems](https://arxiv.org/abs/2609.12551)
...
### [67] [A Dark Forest First Attack Is Rational Only If the Attacker Accepts It as Its Last](https://arxiv.org/abs/2609.12003)
*Harvey Dam*
...
### [68] [PDoS: A Profitable Denial-of-Service Attack against Proof-of-Work Blockchain Liveness](https://arxiv.org/abs/2609.12450)
...
### [69] [Access Control as Verified Parse Constraints](https://arxiv.org/abs/2609.12488)
...
### [70] [A Feature-Rich Embedded NIDS with eBPF/XDP: Detector and Architecture Trade-offs](https://arxiv.org/abs/2609.12605)
...
### [71] [Omniscience for the Masses: New Threats in the Metaverse's Democratized World Creation](https://arxiv.org/abs/2609.12554)
...
### [72] [MicroHasTEE: Bare-Metal Haskell for Type-Level Peripheral Ownership on Armv8-M](https://arxiv.org/abs/2609.12580)
*Robert Krook*
...
### [73] [Poster: Towards Selecting Threat Appropriate Industrial Intrusion Detection Systems](https://arxiv.org/abs/2609.12646)
...
### [74] [Bridging the First-Hour Gap: Evaluating AI Reliability and Benchmarking Deficiencies in Cyber Incident Response for Law Enforcement](https://arxiv.org/abs/2609.12681)
...
### [75] [Fresh-Challenge VDF Attestations for Model-Relative Response Latency](https://arxiv.org/abs/2609.12727)
...
### [76] [Batten the Hatches: Cybersecurity with Military Mariners](https://arxiv.org/abs/2609.12810)
...
### [77] [Self-Verifying Anomaly Detection using Explainable AI for Cybersecurity of DER Networks](https://arxiv.org/abs/2609.12305)
...
### [78] [Evaluating Context Segmentation in Locally Deployable SLMs for Cybersecurity CTF Tasks](https://arxiv.org/abs/2609.12839)
...
### [79] [A Graph-Based Approach for Mapping Kernel-Level Telemetry to MITRE ATT&CK](https://arxiv.org/abs/2609.12841)
